...
__export(v21_exports, {
  ...
  WidgetSchema: () => WidgetV10Schema,
  WithCreditSchema: () => WithCreditV1Schema,
  WithIconSchema: () => WithIconV1Schema
});
module.exports = __toCommonJS(v21_exports);
