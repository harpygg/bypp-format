...
var EntityImageFormatV5Schema = import_zod70.z.enum(ENTITY_IMAGE_RENDITIONS);

// src/models/widget.v5.schema.ts
var EntityImageObjectFitV5Schema = import_zod71.z.enum([
  "contain",
  "cover",
  "fill",
  "none",
...
var WidgetEntityImageV5Schema = WidgetBaseV1Schema.extend({
  type: import_zod71.z.literal("entityImage"),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional()
});
var WidgetV5Schema = import_zod71.z.discriminatedUnion("type", [
  WidgetEmptyV1Schema,
  WidgetBigNumberV1Schema,
  WidgetPlainTextV1Schema,
  WidgetToggleV1Schema,
...
var WidgetV6Schema = import_zod72.z.discriminatedUnion("type", [
  WidgetEmptyV6Schema,
...
var WidgetWheelV7Schema = WidgetBaseV1Schema.merge(
  ...
  type: import_zod73.z.literal("wheel"),
  readingPosition: import_zod73.z.string().optional(),
  labelOrientation: import_zod73.z.string().optional(),
  radius: import_zod73.z.number().optional()
});
var WidgetV7Schema = import_zod73.z.discriminatedUnion("type", [
...
var WithWidgetActionsV8Schema = import_zod74.z.object({
  actionsVariablesUids: import_zod74.z.array(VariableUidSchema).optional()
});
var WidgetActionRollV8Schema = WidgetBaseV1Schema.merge(
  WithStyleV3Schema
).merge(WithWidgetActionsV8Schema).extend({
  type: import_zod74.z.literal("actionRoll")
});
var WidgetV8Schema = import_zod74.z.discriminatedUnion("type", [
...
var WidgetV9Schema = import_zod75.z.discriminatedUnion("type", [
...
var DialectFontV2Schema = import_zod76.z.object({
  fontFamily: import_zod76.z.string(),
  fontUrl: import_zod76.z.string().url()
});
var DialectV2Schema = import_zod76.z.object({
  uid: DialectUidSchema,
  name: import_zod76.z.string(),
  font: DialectFontV2Schema,
  order: import_zod76.z.number().optional(),
  spokenByEntitiesUids: import_zod76.z.array(EntityUidSchema).default([])
});

// src/models/entity.v2.schema.ts
var import_zod77 = require("zod");
var EntityBaseV2Schema = import_zod77.z.object({
  uid: EntityUidSchema,
  displayName: import_zod77.z.string().optional(),
  description: import_zod77.z.string().optional(),
  tagsUid: import_zod77.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod77.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var CharacterEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod77.z.literal("character")
});
var CreatureEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod77.z.literal("creature")
});
var GroupEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod77.z.literal("group"),
  ranks: import_zod77.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod77.z.array(EntityUidSchema).default([])
});
var PlaceEntityV2Schema = EntityBaseV2Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod77.z.literal("place") });
var ItemEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod77.z.literal("item")
});
var NoteEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod77.z.literal("note")
});
var AbilityEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod77.z.literal("ability")
});
var StoryEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod77.z.literal("story")
});
var EventEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod77.z.literal("event")
});
var EntityV2Schema = import_zod77.z.discriminatedUnion("type", [
...
var RandomTableRowV2Schema = import_zod78.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod78.z.number().default(1),
  content: import_zod78.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV2Schema = import_zod78.z.object({
  uid: RandomTableUidSchema,
  title: import_zod78.z.string(),
  rows: import_zod78.z.array(RandomTableRowV2Schema).default([])
});

// src/schemas/bypp.v4.schema.ts
var ParentAttributionV4Schema = import_zod79.z.object({
  bundleName: import_zod79.z.string().min(1),
  authorName: import_zod79.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod79.z.string().url().optional()
});
var BeyondPaperV4Schema = import_zod79.z.object({
  // Format metadata
  version: import_zod79.z.literal(4),
  ...
  variables: import_zod79.z.array(VariableV2Schema).default([]),
  widgets: import_zod79.z.array(WidgetV1Schema).default([]),
...
// src/schemas/bypp.v18.schema.ts
var BeyondPaperV18Schema = import_zod80.z.object({
  // Format metadata
  version: import_zod80.z.literal(18),
  ...
  requires: import_zod80.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod80.z.array(DialectV3Schema).default([]),
  entities: import_zod80.z.array(EntityV4Schema).default([]),
  pages: import_zod80.z.array(PageV1Schema).default([]),
  chunks: import_zod80.z.array(ChunkV11Schema).default([]),
  datasets: import_zod80.z.array(DatasetV2Schema).default([]),
  variables: import_zod80.z.array(VariableV8Schema).default([]),
  widgets: import_zod80.z.array(WidgetV9Schema).default([]),
  sheets: import_zod80.z.array(SheetV7Schema).default([]),
  dataTables: import_zod80.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod80.z.array(RandomTableV7Schema).default([]),
  tags: import_zod80.z.array(TagV3Schema).default([]),
  tagCategories: import_zod80.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod80.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod80.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod80.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod80.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v1.schema.ts
var import_zod81 = require("zod");
var BeyondPaperV1Schema = import_zod81.z.object({
  // Format metadata
  version: import_zod81.z.literal(1),
  ...
  // Content
  dialects: import_zod81.z.array(DialectV1Schema),
  entities: import_zod81.z.array(EntityV1Schema),
  pages: import_zod81.z.array(PageV1Schema),
  chunks: import_zod81.z.array(ChunkV1Schema),
  datasets: import_zod81.z.array(DatasetV1Schema),
  variables: import_zod81.z.array(VariableV1Schema),
  widgets: import_zod81.z.array(WidgetV1Schema),
  randomTables: import_zod81.z.array(RandomTableV1Schema),
  tags: import_zod81.z.array(TagV1Schema),
  tagCategories: import_zod81.z.array(TagCategoryV1Schema),
  scenes: import_zod81.z.array(SceneV1Schema),
  sceneMaps: import_zod81.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod81.z.array(SceneBackgroundV1Schema),
  assets: import_zod81.z.array(AssetV1Schema)
});

// src/schemas/bypp.v2.schema.ts
var import_zod82 = require("zod");
var BeyondPaperV2Schema = import_zod82.z.object({
  // Format metadata
  version: import_zod82.z.literal(2),
  ...
  // Content
  dialects: import_zod82.z.array(DialectV1Schema),
  entities: import_zod82.z.array(EntityV1Schema),
  pages: import_zod82.z.array(PageV1Schema),
  chunks: import_zod82.z.array(ChunkV1Schema),
  datasets: import_zod82.z.array(DatasetV1Schema),
  variables: import_zod82.z.array(VariableV2Schema),
  widgets: import_zod82.z.array(WidgetV1Schema),
  sheets: import_zod82.z.array(SheetV2Schema),
  dataTables: import_zod82.z.array(DataTableV2Schema),
  randomTables: import_zod82.z.array(RandomTableV1Schema),
  tags: import_zod82.z.array(TagV1Schema),
  tagCategories: import_zod82.z.array(TagCategoryV1Schema),
  scenes: import_zod82.z.array(SceneV1Schema),
  sceneMaps: import_zod82.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod82.z.array(SceneBackgroundV1Schema),
  assets: import_zod82.z.array(AssetV1Schema)
});

// src/schemas/bypp.v5.schema.ts
var import_zod83 = require("zod");
var BeyondPaperV5Schema = import_zod83.z.object({
  // Format metadata
  version: import_zod83.z.literal(5),
  ...
  variables: import_zod83.z.array(VariableV5Schema).default([]),
  widgets: import_zod83.z.array(WidgetV5Schema).default([]),
...
var BeyondPaperV6Schema = import_zod84.z.object({
  // Format metadata
  version: import_zod84.z.literal(6),
  ...
  entities: import_zod84.z.array(EntityV2Schema).default([]),
  ...
  variables: import_zod84.z.array(VariableV6Schema).default([]),
  widgets: import_zod84.z.array(WidgetV5Schema).default([]),
  sheets: import_zod84.z.array(SheetV3Schema).default([]),
  dataTables: import_zod84.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod84.z.array(RandomTableV2Schema).default([]),
  ...
  sceneMaps: import_zod84.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod84.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod84.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v7.schema.ts
var import_zod85 = require("zod");
var BeyondPaperV7Schema = import_zod85.z.object({
  // Format metadata
  version: import_zod85.z.literal(7),
  ...
  variables: import_zod85.z.array(VariableV6Schema).default([]),
...
var BeyondPaperV8Schema = import_zod86.z.object({
  // Format metadata
  version: import_zod86.z.literal(8),
  ...
  widgets: import_zod86.z.array(WidgetV6Schema).default([]),
  sheets: import_zod86.z.array(SheetV4Schema).default([]),
...
var BeyondPaperV9Schema = import_zod87.z.object({
  // Format metadata
  version: import_zod87.z.literal(9),
  ...
  variables: import_zod87.z.array(VariableV7Schema).default([]),
  widgets: import_zod87.z.array(WidgetV7Schema).default([]),
  sheets: import_zod87.z.array(SheetV5Schema).default([]),
...
var BeyondPaperV10Schema = import_zod88.z.object({
  // Format metadata
  version: import_zod88.z.literal(10),
  ...
  entities: import_zod88.z.array(EntityV3Schema).default([]),
  ...
  variables: import_zod88.z.array(VariableV7Schema).default([]),
  widgets: import_zod88.z.array(WidgetV7Schema).default([]),
  sheets: import_zod88.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod88.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod88.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod88.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v11.schema.ts
var import_zod89 = require("zod");
var BeyondPaperV11Schema = import_zod89.z.object({
  // Format metadata
  version: import_zod89.z.literal(11),
  ...
  entities: import_zod89.z.array(EntityV3Schema).default([]),
  pages: import_zod89.z.array(PageV1Schema).default([]),
  chunks: import_zod89.z.array(ChunkV11Schema).default([]),
  ...
  sheets: import_zod89.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod89.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod89.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod89.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v12.schema.ts
var import_zod90 = require("zod");
var BeyondPaperV12Schema = import_zod90.z.object({
  // Format metadata
  version: import_zod90.z.literal(12),
...
var BeyondPaperV13Schema = import_zod91.z.object({
  // Format metadata
  version: import_zod91.z.literal(13),
  ...
  entities: import_zod91.z.array(EntityV4Schema).default([]),
  ...
  widgets: import_zod91.z.array(WidgetV9Schema).default([]),
...
var BeyondPaperV14Schema = import_zod92.z.object({
  // Format metadata
  version: import_zod92.z.literal(14),
  ...
  entities: import_zod92.z.array(EntityV4Schema).default([]),
  ...
  widgets: import_zod92.z.array(WidgetV9Schema).default([]),
  sheets: import_zod92.z.array(SheetV7Schema).default([]),
  ...
  sceneMaps: import_zod92.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod92.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod92.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v15.schema.ts
var import_zod93 = require("zod");
var BeyondPaperV15Schema = import_zod93.z.object({
  // Format metadata
  version: import_zod93.z.literal(15),
...
var BeyondPaperV16Schema = import_zod94.z.object({
  // Format metadata
  version: import_zod94.z.literal(16),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod94.z.array(DialectV3Schema).default([]),
  ...
  variables: import_zod94.z.array(VariableV8Schema).default([]),
...
var BeyondPaperV17Schema = import_zod95.z.object({
  // Format metadata
  version: import_zod95.z.literal(17),
  ...
  variables: import_zod95.z.array(VariableV8Schema).default([]),
