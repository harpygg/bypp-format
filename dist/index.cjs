...
__export(index_exports, {
  ...
  BooleanVariableSchema: () => BooleanVariableV8Schema,
  ...
  ChoiceVariableSchema: () => ChoiceVariableV8Schema,
  ...
  DataTableDirectLookupVariableSchema: () => DataTableDirectLookupVariableV8Schema,
  ...
  DataTableLookupVariableSchema: () => DataTableLookupVariableV8Schema,
  ...
  DataTableRefVariableSchema: () => DataTableRefVariableV8Schema,
  ...
  EntityLookupVariableSchema: () => EntityLookupVariableV9Schema,
  EntityLookupVariableV9Schema: () => EntityLookupVariableV9Schema,
  EntityRefVariableSchema: () => EntityRefVariableV9Schema,
  ...
  FormulaVariableSchema: () => FormulaVariableV8Schema,
  ...
  ImageVariableSchema: () => ImageVariableV8Schema,
  ...
  NumberVariableSchema: () => NumberVariableV8Schema,
...
var WithIconV1Schema = import_zod47.z.object({
  icon: import_zod47.z.string().optional()
});

// src/models/variable.v5.schema.ts
var import_zod48 = require("zod");
var ImageVariableV5Schema = VariableBaseV1Schema.extend({
  type: import_zod48.z.literal("image")
});
var VariableV5Schema = import_zod48.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var DataTableDirectLookupVariableV6Schema = VariableBaseV1Schema.extend(
  {
    type: import_zod49.z.literal("dataTableDirectLookup"),
    dataTableUid: DataTableUidSchema.optional(),
    columnUid: DataTableColumnUidSchema.optional(),
    rowUids: import_zod49.z.array(DataTableRowUidSchema).optional(),
    chainedLabelColumnUids: import_zod49.z.array(DataTableColumnUidSchema).optional(),
    multiAggregator: import_zod49.z.enum(["concat", "sum", "avg", "min", "max"]).optional(),
    multiSeparator: import_zod49.z.string().optional()
  }
);
var VariableV6Schema = import_zod49.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var NumberVariableV2Schema = NumberVariableV1Schema.extend({
  min: import_zod50.z.number().optional(),
  max: import_zod50.z.number().optional(),
  step: import_zod50.z.number().optional()
});
var VariableV7Schema = import_zod50.z.discriminatedUnion("type", [
...
var VariableV8Schema = import_zod51.z.discriminatedUnion("type", [
...
var EntityRefVariableV9Schema = VariableBaseV8Schema.extend({
  type: import_zod52.z.literal("entityRef"),
  sourceVariableUid: VariableUidSchema.optional(),
  targetsTypes: import_zod52.z.array(import_zod52.z.string()).optional(),
  targetsTags: import_zod52.z.array(TagUidSchema).optional(),
  targetTagsGroup: import_zod52.z.enum(["every", "some"]).optional(),
  max: import_zod52.z.number().optional(),
  maxVariable: VariableUidSchema.nullable().optional()
});
var EntityLookupVariableV9Schema = VariableBaseV8Schema.extend({
  type: import_zod52.z.literal("entityLookup"),
  sourceVariableUid: VariableUidSchema.optional(),
  keyVariableUid: VariableUidSchema.optional(),
  labelVariableUid: VariableUidSchema.optional(),
  multiAggregator: import_zod52.z.enum(["concat", "sum", "avg", "min", "max"]).optional(),
  multiSeparator: import_zod52.z.string().optional()
});
var VariableV9Schema = import_zod52.z.discriminatedUnion("type", [
  NumberVariableV8Schema,
  TextVariableV8Schema,
  BooleanVariableV8Schema,
  ChoiceVariableV8Schema,
...
// src/models/variable.v10.schema.ts
var VariableUpdateV26Schema = import_zod53.z.object({
  variableUid: VariableUidSchema,
  formula: import_zod53.z.string()
});
var ActionRollV26Schema = import_zod53.z.object({
  key: import_zod53.z.string(),
  label: import_zod53.z.string(),
  diceFormula: import_zod53.z.string()
});
var ActionSectionsV26Schema = import_zod53.z.object({
  rolls: import_zod53.z.array(ActionRollV26Schema).optional(),
  updates: import_zod53.z.array(VariableUpdateV26Schema).optional(),
  log: import_zod53.z.string().optional()
});
var RollVariableV10Schema = RollVariableV8Schema.merge(
  ActionSectionsV26Schema
);
var VariableV10Schema = import_zod53.z.discriminatedUnion("type", [
  NumberVariableV8Schema,
  TextVariableV8Schema,
  BooleanVariableV8Schema,
  ChoiceVariableV8Schema,
...
// src/models/entity-action.v2.schema.ts
var EntityActionV2Schema = import_zod54.z.object({
  uid: EntityActionUidSchema,
  label: TranslatableTextV2Schema,
  visual: ActionVisualV1Schema.optional(),
  hue: import_zod54.z.number().nullable().optional(),
  type: import_zod54.z.literal("roll"),
  diceFormula: import_zod54.z.string().optional()
...
var WithArchiveV2Schema = import_zod55.z.object({
  isArchived: import_zod55.z.boolean().default(false)
});

// src/mixins/with-pages.v2.schema.ts
var import_zod56 = require("zod");
var WithPagesV2Schema = import_zod56.z.object({
  pagesOrder: import_zod56.z.array(PageUidSchema).default([])
});

// src/models/entity.v3.schema.ts
var EntityBaseV3Schema = import_zod57.z.object({
  uid: EntityUidSchema,
  displayName: import_zod57.z.string().optional(),
  description: import_zod57.z.string().optional(),
  tagsUid: import_zod57.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod57.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var CharacterEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod57.z.literal("character")
});
var CreatureEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod57.z.literal("creature")
});
var GroupEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod57.z.literal("group"),
  ranks: import_zod57.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod57.z.array(EntityUidSchema).default([])
});
var PlaceEntityV3Schema = EntityBaseV3Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod57.z.literal("place") });
var ItemEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod57.z.literal("item")
});
var NoteEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod57.z.literal("note")
});
var AbilityEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod57.z.literal("ability")
});
var StoryEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod57.z.literal("story")
});
var EventEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod57.z.literal("event")
});
var EntityV3Schema = import_zod57.z.discriminatedUnion("type", [
...
var CharacterEntityV4Schema = EntityBaseV4Schema.extend({
  type: import_zod58.z.literal("character")
});
var CreatureEntityV4Schema = EntityBaseV4Schema.extend({
  type: import_zod58.z.literal("creature")
});
var GroupEntityV4Schema = EntityBaseV4Schema.extend({
  type: import_zod58.z.literal("group"),
  ranks: import_zod58.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod58.z.array(EntityUidSchema).default([])
});
var PlaceEntityV4Schema = EntityBaseV4Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod58.z.literal("place") });
var ItemEntityV4Schema = EntityBaseV4Schema.extend({
  type: import_zod58.z.literal("item")
});
var NoteEntityV4Schema = EntityBaseV4Schema.extend({
  type: import_zod58.z.literal("note")
});
var AbilityEntityV4Schema = EntityBaseV4Schema.extend({
  type: import_zod58.z.literal("ability")
});
var StoryEntityV4Schema = EntityBaseV4Schema.extend({
  type: import_zod58.z.literal("story")
});
var EventEntityV4Schema = EntityBaseV4Schema.extend({
  type: import_zod58.z.literal("event")
});
var EntityV4Schema = import_zod58.z.discriminatedUnion("type", [
...
var EntityBaseV6Schema = EntityBaseV4Schema.extend({
  actions: import_zod59.z.array(EntityActionV2Schema).default([])
});
...
var EntityV6Schema = import_zod59.z.discriminatedUnion("type", [
...
var RandomTableRowV7Schema = import_zod60.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod60.z.number().default(1),
  content: import_zod60.z.string(),
  randomTableRefs: import_zod60.z.record(RandomTableUidSchema).optional()
});
var RandomTableV7Schema = import_zod60.z.object({
  uid: RandomTableUidSchema,
  title: import_zod60.z.string(),
  rows: import_zod60.z.array(RandomTableRowV7Schema).default([]),
  diceFormula: import_zod60.z.string().optional()
});

// src/models/requirement.v1.schema.ts
var import_zod61 = require("zod");
var ByppFileUrlV1Schema = import_zod61.z.string().url().refine(
  (url) => {
    try {
...
var RequirementSourceV1Schema = import_zod61.z.object({
  byppUrl: ByppFileUrlV1Schema,
  bundleName: import_zod61.z.string().optional(),
  bundleVersion: import_zod61.z.string().optional()
});
var RequirementV1Schema = import_zod61.z.object({
  category: import_zod61.z.string(),
  uid: import_zod61.z.string(),
...
var SceneV2Schema = import_zod62.z.object({ uid: SceneUidSchema }).merge(WithNameV1Schema).extend({
...
var SceneBackgroundBaseV2Schema = import_zod63.z.object({ uid: SceneBackgroundUidSchema }).merge(WithNameV1Schema).extend({
...
var SceneBackgroundV2Schema = import_zod63.z.discriminatedUnion("type", [
...
var CustomImageSceneBackgroundV3Schema = SceneBackgroundBaseV2Schema.merge(WithImagesUrlsV3Schema).extend({
  type: import_zod64.z.literal("customImage")
});
var CustomVideoSceneBackgroundV3Schema = SceneBackgroundBaseV2Schema.merge(WithVideoUrlsV2Schema).extend({
  type: import_zod64.z.literal("customVideo")
});
var SceneBackgroundV3Schema = import_zod64.z.discriminatedUnion("type", [
...
var SceneBackgroundV4Schema = import_zod65.z.discriminatedUnion("type", [
...
var SceneMapBaseV2Schema = import_zod66.z.object({ uid: SceneMapUidSchema }).merge(WithNameV1Schema).extend({
  grid: GridDataV1Schema,
  sourceFormat: import_zod66.z.string().optional()
});
...
var SceneMapV2Schema = import_zod66.z.discriminatedUnion("type", [
...
var SceneMapV3Schema = import_zod67.z.discriminatedUnion("type", [
...
var SceneMapV4Schema = import_zod68.z.discriminatedUnion("type", [
...
var ObjectFitV6Schema = import_zod69.z.enum([
  "cover",
  "contain",
  "fill",
  "none",
...
var WidgetBackgroundV6Schema = import_zod69.z.object({
  assetUid: AssetUidSchema,
  objectFit: ObjectFitV6Schema.optional()
});
var StyleV2Schema = import_zod69.z.object({
  justifyContent: import_zod69.z.string().optional(),
  alignItems: import_zod69.z.string().optional(),
  flexDirection: import_zod69.z.string().optional(),
  lineHeight: import_zod69.z.number().optional(),
  fontFamilyId: import_zod69.z.string().optional(),
  fontScale: import_zod69.z.number().optional(),
  color: import_zod69.z.string().optional(),
  paddingTop: import_zod69.z.number().optional(),
  paddingRight: import_zod69.z.number().optional(),
  paddingBottom: import_zod69.z.number().optional(),
  paddingLeft: import_zod69.z.number().optional(),
  // New in v2:
  borderWidth: import_zod69.z.number().optional(),
  borderStyle: import_zod69.z.string().optional(),
  borderColor: import_zod69.z.string().optional(),
  borderRadius: import_zod69.z.string().optional(),
  background: WidgetBackgroundV6Schema.optional()
}).nullable().optional();
var WithStyleV2Schema = import_zod69.z.object({
  style: StyleV2Schema
});

// src/mixins/with-style.v3.schema.ts
var StyleV3Schema = StyleV2Schema.unwrap().unwrap().extend({
  rotation: import_zod70.z.number().optional()
}).nullable().optional();
var WithStyleV3Schema = import_zod70.z.object({
  style: StyleV3Schema
});
...
var SheetV3Schema = import_zod71.z.object({ uid: SheetUidSchema }).merge(WithImagesUrlsV2Schema).extend({
  name: import_zod71.z.string().optional(),
  widgetUids: import_zod71.z.array(WidgetUidSchema).default([]),
  compatibleDatasetUid: DatasetUidSchema.optional()
});

// src/models/sheet.v4.schema.ts
var SheetV4Schema = SheetV3Schema.extend({
  styles: import_zod72.z.record(import_zod72.z.string(), StyleV2Schema).optional()
});

// src/models/sheet.v5.schema.ts
var SheetV5Schema = SheetV4Schema.extend({
  styles: import_zod73.z.record(import_zod73.z.string(), StyleV3Schema).optional()
});
...
var TagV2Schema = import_zod74.z.object({ uid: TagUidSchema }).merge(WithNameV1Schema).extend({
  categoryUid: TagCategoryUidSchema.optional(),
  useAsFolder: import_zod74.z.boolean().default(false)
});
...
var StyleV4Schema = StyleV3Schema.unwrap().unwrap().extend({
  fontWeight: import_zod75.z.string().optional(),
  fontStyle: import_zod75.z.string().optional()
}).nullable().optional();
var WithStyleV4Schema = import_zod75.z.object({
  style: StyleV4Schema
});

// src/mixins/with-style.v5.schema.ts
var StyleV5Schema = StyleV4Schema.unwrap().unwrap().extend({
  marginTop: import_zod76.z.number().optional(),
  marginRight: import_zod76.z.number().optional(),
  marginBottom: import_zod76.z.number().optional(),
  marginLeft: import_zod76.z.number().optional(),
  backgroundColor: import_zod76.z.string().optional(),
  textDecoration: import_zod76.z.string().optional(),
  backgroundRepeat: import_zod76.z.boolean().optional()
}).nullable().optional();
var WithStyleV5Schema = import_zod76.z.object({
  style: StyleV5Schema
});

// src/mixins/with-style.v6.schema.ts
var SideV6Schema = import_zod77.z.number();
var SidesV6Schema = import_zod77.z.union([
  SideV6Schema,
  import_zod77.z.array(SideV6Schema).refine((sides) => sides.length === 2 || sides.length === 4, {
...
var WithStyleV6Schema = import_zod77.z.object({
  style: StyleV6Schema
});

// src/models/theme.v25.schema.ts
var ThemeStyleV25Schema = StyleV6Schema.unwrap().unwrap();
var ThemeTagStyleV25Schema = import_zod78.z.object({
  tagUid: TagUidSchema,
  style: ThemeStyleV25Schema
});
var ThemeV25Schema = import_zod78.z.object({
  slug: import_zod78.z.string().optional(),
  elements: import_zod78.z.record(import_zod78.z.string(), ThemeStyleV25Schema).default({}),
  tagStyles: import_zod78.z.array(ThemeTagStyleV25Schema).default([])
});
...
var EntityImageFormatV5Schema = import_zod79.z.enum(ENTITY_IMAGE_RENDITIONS);

// src/models/widget.v5.schema.ts
var EntityImageObjectFitV5Schema = import_zod80.z.enum([
  "contain",
  "cover",
  "fill",
  "none",
...
var WidgetEntityImageV5Schema = WidgetBaseV1Schema.extend({
  type: import_zod80.z.literal("entityImage"),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional()
});
var WidgetV5Schema = import_zod80.z.discriminatedUnion("type", [
  WidgetEmptyV1Schema,
  WidgetBigNumberV1Schema,
  WidgetPlainTextV1Schema,
  WidgetToggleV1Schema,
...
var WidgetV6Schema = import_zod81.z.discriminatedUnion("type", [
  WidgetEmptyV6Schema,
...
var WidgetWheelV7Schema = WidgetBaseV1Schema.merge(
  ...
  type: import_zod82.z.literal("wheel"),
  readingPosition: import_zod82.z.string().optional(),
  labelOrientation: import_zod82.z.string().optional(),
  radius: import_zod82.z.number().optional()
});
var WidgetV7Schema = import_zod82.z.discriminatedUnion("type", [
...
var WithWidgetActionsV8Schema = import_zod83.z.object({
  actionsVariablesUids: import_zod83.z.array(VariableUidSchema).optional()
});
var WidgetActionRollV8Schema = WidgetBaseV1Schema.merge(
  WithStyleV3Schema
).merge(WithWidgetActionsV8Schema).extend({
  type: import_zod83.z.literal("actionRoll")
});
var WidgetV8Schema = import_zod83.z.discriminatedUnion("type", [
...
var WidgetV9Schema = import_zod84.z.discriminatedUnion("type", [
...
var WidgetEntityGridV10Schema = WidgetBaseV1Schema.extend({
  type: import_zod85.z.literal("entityGrid"),
  gapX: import_zod85.z.number().optional(),
  gapY: import_zod85.z.number().optional(),
  listOptionStyle: import_zod85.z.string().optional(),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional(),
  imageWidth: import_zod85.z.number().optional(),
  imageHeight: import_zod85.z.number().optional()
}).merge(WithStyleV3Schema).merge(WithWidgetActionsV8Schema).merge(WithCreditV1Schema);
var WidgetV10Schema = import_zod85.z.discriminatedUnion("type", [
  ...WidgetV9Schema.options,
  WidgetEntityGridV10Schema
]);

// src/models/widget.v13.schema.ts
var WidgetV13Schema = import_zod86.z.discriminatedUnion("type", [
...
var DialectFontV2Schema = import_zod87.z.object({
  fontFamily: import_zod87.z.string(),
  fontUrl: import_zod87.z.string().url()
});
var DialectV2Schema = import_zod87.z.object({
  uid: DialectUidSchema,
  name: import_zod87.z.string(),
  font: DialectFontV2Schema,
  order: import_zod87.z.number().optional(),
  spokenByEntitiesUids: import_zod87.z.array(EntityUidSchema).default([])
});

// src/models/entity.v2.schema.ts
var import_zod88 = require("zod");
var EntityBaseV2Schema = import_zod88.z.object({
  uid: EntityUidSchema,
  displayName: import_zod88.z.string().optional(),
  description: import_zod88.z.string().optional(),
  tagsUid: import_zod88.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod88.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var CharacterEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod88.z.literal("character")
});
var CreatureEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod88.z.literal("creature")
});
var GroupEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod88.z.literal("group"),
  ranks: import_zod88.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod88.z.array(EntityUidSchema).default([])
});
var PlaceEntityV2Schema = EntityBaseV2Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod88.z.literal("place") });
var ItemEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod88.z.literal("item")
});
var NoteEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod88.z.literal("note")
});
var AbilityEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod88.z.literal("ability")
});
var StoryEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod88.z.literal("story")
});
var EventEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod88.z.literal("event")
});
var EntityV2Schema = import_zod88.z.discriminatedUnion("type", [
...
var RandomTableRowV2Schema = import_zod89.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod89.z.number().default(1),
  content: import_zod89.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV2Schema = import_zod89.z.object({
  uid: RandomTableUidSchema,
  title: import_zod89.z.string(),
  rows: import_zod89.z.array(RandomTableRowV2Schema).default([])
});

// src/schemas/bypp.v4.schema.ts
var ParentAttributionV4Schema = import_zod90.z.object({
  bundleName: import_zod90.z.string().min(1),
  authorName: import_zod90.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod90.z.string().url().optional()
});
var BeyondPaperV4Schema = import_zod90.z.object({
  // Format metadata
  version: import_zod90.z.literal(4),
  ...
  variables: import_zod90.z.array(VariableV2Schema).default([]),
  widgets: import_zod90.z.array(WidgetV1Schema).default([]),
...
// src/schemas/bypp.v26.schema.ts
var BeyondPaperV26Schema = import_zod91.z.object({
  // Format metadata
  version: import_zod91.z.literal(26),
  ...
  requires: import_zod91.z.array(RequirementV1Schema).default([]),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod91.z.array(DialectV3Schema).default([]),
  entities: import_zod91.z.array(EntityV6Schema).default([]),
  pages: import_zod91.z.array(PageV1Schema).default([]),
  chunks: import_zod91.z.array(ChunkV12Schema).default([]),
  datasets: import_zod91.z.array(DatasetV2Schema).default([]),
  variables: import_zod91.z.array(VariableV10Schema).default([]),
  widgets: import_zod91.z.array(WidgetV13Schema).default([]),
  sheets: import_zod91.z.array(SheetV7Schema).default([]),
  dataTables: import_zod91.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod91.z.array(RandomTableV7Schema).default([]),
  tags: import_zod91.z.array(TagV3Schema).default([]),
  tagCategories: import_zod91.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod91.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod91.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod91.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod91.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v1.schema.ts
var import_zod92 = require("zod");
var BeyondPaperV1Schema = import_zod92.z.object({
  // Format metadata
  version: import_zod92.z.literal(1),
  ...
  // Content
  dialects: import_zod92.z.array(DialectV1Schema),
  entities: import_zod92.z.array(EntityV1Schema),
  pages: import_zod92.z.array(PageV1Schema),
  chunks: import_zod92.z.array(ChunkV1Schema),
  datasets: import_zod92.z.array(DatasetV1Schema),
  variables: import_zod92.z.array(VariableV1Schema),
  widgets: import_zod92.z.array(WidgetV1Schema),
  randomTables: import_zod92.z.array(RandomTableV1Schema),
  tags: import_zod92.z.array(TagV1Schema),
  tagCategories: import_zod92.z.array(TagCategoryV1Schema),
  scenes: import_zod92.z.array(SceneV1Schema),
  sceneMaps: import_zod92.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod92.z.array(SceneBackgroundV1Schema),
  assets: import_zod92.z.array(AssetV1Schema)
});

// src/schemas/bypp.v2.schema.ts
var import_zod93 = require("zod");
var BeyondPaperV2Schema = import_zod93.z.object({
  // Format metadata
  version: import_zod93.z.literal(2),
  ...
  // Content
  dialects: import_zod93.z.array(DialectV1Schema),
  entities: import_zod93.z.array(EntityV1Schema),
  pages: import_zod93.z.array(PageV1Schema),
  chunks: import_zod93.z.array(ChunkV1Schema),
  datasets: import_zod93.z.array(DatasetV1Schema),
  variables: import_zod93.z.array(VariableV2Schema),
  widgets: import_zod93.z.array(WidgetV1Schema),
  sheets: import_zod93.z.array(SheetV2Schema),
  dataTables: import_zod93.z.array(DataTableV2Schema),
  randomTables: import_zod93.z.array(RandomTableV1Schema),
  tags: import_zod93.z.array(TagV1Schema),
  tagCategories: import_zod93.z.array(TagCategoryV1Schema),
  scenes: import_zod93.z.array(SceneV1Schema),
  sceneMaps: import_zod93.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod93.z.array(SceneBackgroundV1Schema),
  assets: import_zod93.z.array(AssetV1Schema)
});

// src/schemas/bypp.v5.schema.ts
var import_zod94 = require("zod");
var BeyondPaperV5Schema = import_zod94.z.object({
  // Format metadata
  version: import_zod94.z.literal(5),
  ...
  variables: import_zod94.z.array(VariableV5Schema).default([]),
  widgets: import_zod94.z.array(WidgetV5Schema).default([]),
...
var BeyondPaperV6Schema = import_zod95.z.object({
  // Format metadata
  version: import_zod95.z.literal(6),
  ...
  variables: import_zod95.z.array(VariableV6Schema).default([]),
  widgets: import_zod95.z.array(WidgetV5Schema).default([]),
...
var BeyondPaperV7Schema = import_zod96.z.object({
  // Format metadata
  version: import_zod96.z.literal(7),
  ...
  entities: import_zod96.z.array(EntityV2Schema).default([]),
  pages: import_zod96.z.array(PageV1Schema).default([]),
  chunks: import_zod96.z.array(ChunkV2Schema).default([]),
  datasets: import_zod96.z.array(DatasetV2Schema).default([]),
  variables: import_zod96.z.array(VariableV6Schema).default([]),
  widgets: import_zod96.z.array(WidgetV5Schema).default([]),
  sheets: import_zod96.z.array(SheetV3Schema).default([]),
  ...
  sceneMaps: import_zod96.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod96.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod96.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v8.schema.ts
var import_zod97 = require("zod");
var BeyondPaperV8Schema = import_zod97.z.object({
  // Format metadata
  version: import_zod97.z.literal(8),
  ...
  entities: import_zod97.z.array(EntityV2Schema).default([]),
  pages: import_zod97.z.array(PageV1Schema).default([]),
  chunks: import_zod97.z.array(ChunkV2Schema).default([]),
  datasets: import_zod97.z.array(DatasetV2Schema).default([]),
  variables: import_zod97.z.array(VariableV6Schema).default([]),
  widgets: import_zod97.z.array(WidgetV6Schema).default([]),
  sheets: import_zod97.z.array(SheetV4Schema).default([]),
  ...
  sceneMaps: import_zod97.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod97.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod97.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v9.schema.ts
var import_zod98 = require("zod");
var BeyondPaperV9Schema = import_zod98.z.object({
  // Format metadata
  version: import_zod98.z.literal(9),
  ...
  widgets: import_zod98.z.array(WidgetV7Schema).default([]),
  sheets: import_zod98.z.array(SheetV5Schema).default([]),
...
var BeyondPaperV10Schema = import_zod99.z.object({
  // Format metadata
  version: import_zod99.z.literal(10),
  ...
  entities: import_zod99.z.array(EntityV3Schema).default([]),
  ...
  widgets: import_zod99.z.array(WidgetV7Schema).default([]),
  sheets: import_zod99.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod99.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod99.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod99.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v11.schema.ts
var import_zod100 = require("zod");
var BeyondPaperV11Schema = import_zod100.z.object({
  // Format metadata
  version: import_zod100.z.literal(11),
  ...
  entities: import_zod100.z.array(EntityV3Schema).default([]),
  ...
  widgets: import_zod100.z.array(WidgetV7Schema).default([]),
  sheets: import_zod100.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod100.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod100.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod100.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v12.schema.ts
var import_zod101 = require("zod");
var BeyondPaperV12Schema = import_zod101.z.object({
  // Format metadata
  version: import_zod101.z.literal(12),
  ...
  entities: import_zod101.z.array(EntityV3Schema).default([]),
  ...
  variables: import_zod101.z.array(VariableV7Schema).default([]),
  widgets: import_zod101.z.array(WidgetV8Schema).default([]),
  sheets: import_zod101.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod101.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod101.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod101.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v13.schema.ts
var import_zod102 = require("zod");
var BeyondPaperV13Schema = import_zod102.z.object({
  // Format metadata
  version: import_zod102.z.literal(13),
...
var BeyondPaperV14Schema = import_zod103.z.object({
  // Format metadata
  version: import_zod103.z.literal(14),
...
var BeyondPaperV15Schema = import_zod104.z.object({
  // Format metadata
  version: import_zod104.z.literal(15),
  ...
  widgets: import_zod104.z.array(WidgetV9Schema).default([]),
...
var BeyondPaperV16Schema = import_zod105.z.object({
  // Format metadata
  version: import_zod105.z.literal(16),
  ...
  entities: import_zod105.z.array(EntityV4Schema).default([]),
  ...
  variables: import_zod105.z.array(VariableV8Schema).default([]),
  widgets: import_zod105.z.array(WidgetV9Schema).default([]),
...
var BeyondPaperV17Schema = import_zod106.z.object({
  // Format metadata
  version: import_zod106.z.literal(17),
  ...
  variables: import_zod106.z.array(VariableV8Schema).default([]),
...
var BeyondPaperV18Schema = import_zod107.z.object({
  // Format metadata
  version: import_zod107.z.literal(18),
  ...
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod107.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod107.z.array(DialectV3Schema).default([]),
  ...
  variables: import_zod107.z.array(VariableV8Schema).default([]),
  ...
  tags: import_zod107.z.array(TagV3Schema).default([]),
  tagCategories: import_zod107.z.array(TagCategoryV2Schema).default([]),
...
var BeyondPaperV19Schema = import_zod108.z.object({
  // Format metadata
  version: import_zod108.z.literal(19),
  ...
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod108.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  ...
  variables: import_zod108.z.array(VariableV9Schema).default([]),
  widgets: import_zod108.z.array(WidgetV10Schema).default([]),
  ...
  tags: import_zod108.z.array(TagV3Schema).default([]),
  tagCategories: import_zod108.z.array(TagCategoryV2Schema).default([]),
...
var EntityActionV1Schema = import_zod109.z.object({
  uid: EntityActionUidSchema,
  label: TranslatableTextV2Schema,
  visual: ActionVisualV1Schema.optional(),
  hue: import_zod109.z.number().nullable().optional(),
  type: import_zod109.z.literal("roll"),
  diceFormula: import_zod109.z.string().optional()
});

// src/models/entity.v5.schema.ts
var EntityBaseV5Schema = EntityBaseV4Schema.extend({
  actions: import_zod110.z.array(EntityActionV1Schema).default([])
});
var CharacterEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod110.z.literal("character")
});
var CreatureEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod110.z.literal("creature")
});
var GroupEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod110.z.literal("group"),
  ranks: import_zod110.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod110.z.array(EntityUidSchema).default([])
});
var PlaceEntityV5Schema = EntityBaseV5Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod110.z.literal("place") });
var ItemEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod110.z.literal("item")
});
var NoteEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod110.z.literal("note")
});
var AbilityEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod110.z.literal("ability")
});
var StoryEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod110.z.literal("story")
});
var EventEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod110.z.literal("event")
});
var EntityV5Schema = import_zod110.z.discriminatedUnion("type", [
...
// src/schemas/bypp.v20.schema.ts
var BeyondPaperV20Schema = import_zod111.z.object({
  // Format metadata
  version: import_zod111.z.literal(20),
  ...
  entities: import_zod111.z.array(EntityV5Schema).default([]),
  ...
  variables: import_zod111.z.array(VariableV9Schema).default([]),
  widgets: import_zod111.z.array(WidgetV10Schema).default([]),
...
var BeyondPaperV21Schema = import_zod112.z.object({
  // Format metadata
  version: import_zod112.z.literal(21),
  ...
  entities: import_zod112.z.array(EntityV5Schema).default([]),
  pages: import_zod112.z.array(PageV1Schema).default([]),
  chunks: import_zod112.z.array(ChunkV12Schema).default([]),
...
var WidgetV11Schema = import_zod113.z.discriminatedUnion("type", [
...
// src/schemas/bypp.v22.schema.ts
var BeyondPaperV22Schema = import_zod114.z.object({
  // Format metadata
  version: import_zod114.z.literal(22),
  format: import_zod114.z.literal("bypp"),
  // Bundle metadata
  name: import_zod114.z.string(),
  exportedAt: import_zod114.z.string(),
  bundleVersion: import_zod114.z.string(),
  // The bundle's cover. Optional: a bundle with no cover simply omits it,
  // and so does every document produced before v14.
  image: BundleImageV14Schema.optional(),
  // Licensing & attribution
  license: CcLicenseV3Schema,
  licenseVersion: import_zod114.z.literal("4.0"),
  attribution: AttributionV3Schema,
  parentAttribution: ParentAttributionV4Schema.optional(),
  creatorLinks: import_zod114.z.array(import_zod114.z.string().url()).optional(),
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod114.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod114.z.array(DialectV3Schema).default([]),
  entities: import_zod114.z.array(EntityV5Schema).default([]),
  pages: import_zod114.z.array(PageV1Schema).default([]),
  chunks: import_zod114.z.array(ChunkV12Schema).default([]),
  datasets: import_zod114.z.array(DatasetV2Schema).default([]),
  variables: import_zod114.z.array(VariableV9Schema).default([]),
  widgets: import_zod114.z.array(WidgetV11Schema).default([]),
  sheets: import_zod114.z.array(SheetV7Schema).default([]),
  dataTables: import_zod114.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod114.z.array(RandomTableV7Schema).default([]),
  tags: import_zod114.z.array(TagV3Schema).default([]),
  tagCategories: import_zod114.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod114.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod114.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod114.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod114.z.array(AssetV3Schema).default([])
});
...
var WidgetV12Schema = import_zod115.z.discriminatedUnion("type", [
...
// src/schemas/bypp.v23.schema.ts
var BeyondPaperV23Schema = import_zod116.z.object({
  // Format metadata
  version: import_zod116.z.literal(23),
  ...
  widgets: import_zod116.z.array(WidgetV12Schema).default([]),
...
var BeyondPaperV24Schema = import_zod117.z.object({
  // Format metadata
  version: import_zod117.z.literal(24),
  ...
  widgets: import_zod117.z.array(WidgetV13Schema).default([]),
...
var BeyondPaperV25Schema = import_zod118.z.object({
  // Format metadata
  version: import_zod118.z.literal(25),
  ...
  widgets: import_zod118.z.array(WidgetV13Schema).default([]),
