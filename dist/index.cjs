...
__export(index_exports, {
  ...
  BeyondPaperSchema: () => BeyondPaperV28Schema,
...
var WithIconV1Schema = import_zod44.z.object({
...
var VariableV8Schema = import_zod48.z.discriminatedUnion("type", [
...
var EntityRefVariableV9Schema = VariableBaseV8Schema.extend({
  type: import_zod49.z.literal("entityRef"),
  sourceVariableUid: VariableUidSchema.optional(),
  targetsTypes: import_zod49.z.array(import_zod49.z.string()).optional(),
  targetsTags: import_zod49.z.array(TagUidSchema).optional(),
  targetTagsGroup: import_zod49.z.enum(["every", "some"]).optional(),
  max: import_zod49.z.number().optional(),
  maxVariable: VariableUidSchema.nullable().optional()
});
var EntityLookupVariableV9Schema = VariableBaseV8Schema.extend({
  type: import_zod49.z.literal("entityLookup"),
  sourceVariableUid: VariableUidSchema.optional(),
  keyVariableUid: VariableUidSchema.optional(),
  labelVariableUid: VariableUidSchema.optional(),
  multiAggregator: import_zod49.z.enum(["concat", "sum", "avg", "min", "max"]).optional(),
  multiSeparator: import_zod49.z.string().optional()
});
var VariableV9Schema = import_zod49.z.discriminatedUnion("type", [
  NumberVariableV8Schema,
  TextVariableV8Schema,
  BooleanVariableV8Schema,
  ChoiceVariableV8Schema,
...
var VariableUpdateV26Schema = import_zod50.z.object({
  variableUid: VariableUidSchema,
  formula: import_zod50.z.string()
});
var ActionRollV26Schema = import_zod50.z.object({
  key: import_zod50.z.string(),
  label: import_zod50.z.string(),
  diceFormula: import_zod50.z.string()
});
var ActionSectionsV26Schema = import_zod50.z.object({
  rolls: import_zod50.z.array(ActionRollV26Schema).optional(),
  updates: import_zod50.z.array(VariableUpdateV26Schema).optional(),
  log: import_zod50.z.string().optional()
});
var RollVariableV10Schema = RollVariableV8Schema.merge(
  ActionSectionsV26Schema
);
var VariableV10Schema = import_zod50.z.discriminatedUnion("type", [
  NumberVariableV8Schema,
  TextVariableV8Schema,
  BooleanVariableV8Schema,
  ChoiceVariableV8Schema,
...
// src/models/variable.v11.schema.ts
var VariableLabelV27Schema = import_zod51.z.object({
  label: TranslatableTextV2Schema.optional()
});
...
var ChoiceVariableV11Schema = ChoiceVariableV8Schema.merge(
  ...
  options: import_zod51.z.array(ChoiceOptionV27Schema).optional()
});
...
var VariableV11Schema = import_zod51.z.discriminatedUnion("type", [
...
var DataTableColumnV4Schema = import_zod52.z.discriminatedUnion("type", [
  DataTableColumnNumberV2Schema,
  DataTableColumnTextV2Schema,
  DataTableColumnBooleanV2Schema,
...
var DataTableV4Schema = import_zod52.z.object({ uid: DataTableUidSchema }).merge(WithLocalizedNameV2Schema).extend({
  icon: import_zod52.z.string().optional(),
  weight: import_zod52.z.number().optional(),
  adminOnly: import_zod52.z.boolean().optional(),
  sourceUid: DataTableUidSchema.optional(),
  columns: import_zod52.z.array(DataTableColumnV4Schema).default([]),
  rows: import_zod52.z.array(DataTableRowV3Schema).default([])
});

// src/models/dataset.v2.schema.ts
var import_zod53 = require("zod");
var DatasetTargetV2Schema = import_zod53.z.union([
  EntityTypeV1Schema,
  TagUidSchema
]);
var DatasetV2Schema = import_zod53.z.object({ uid: DatasetUidSchema }).merge(WithNameV1Schema).extend({
  weight: import_zod53.z.number().optional(),
  targets: import_zod53.z.array(DatasetTargetV2Schema).default([]),
  targetTagsGroup: import_zod53.z.enum(["every", "some"]).optional(),
  sheetUid: SheetUidSchema.optional()
});

// src/models/dialect.v3.schema.ts
var import_zod54 = require("zod");
var DialectV3Schema = import_zod54.z.object({
  uid: DialectUidSchema,
  name: import_zod54.z.string(),
  fontFamily: import_zod54.z.string().optional(),
  order: import_zod54.z.number().optional(),
  spokenByEntitiesUids: import_zod54.z.array(EntityUidSchema).default([])
});
...
var WithScenesV2Schema = import_zod55.z.object({
  scenesUids: import_zod55.z.array(SceneUidSchema).default([])
});

// src/models/entity-action.v2.schema.ts
var import_zod56 = require("zod");
var EntityActionV2Schema = import_zod56.z.object({
  uid: EntityActionUidSchema,
  label: TranslatableTextV2Schema,
  visual: ActionVisualV1Schema.optional(),
  hue: import_zod56.z.number().nullable().optional(),
  type: import_zod56.z.literal("roll"),
  diceFormula: import_zod56.z.string().optional()
...
var WithArchiveV2Schema = import_zod57.z.object({
  isArchived: import_zod57.z.boolean().default(false)
});

// src/mixins/with-pages.v2.schema.ts
var import_zod58 = require("zod");
var WithPagesV2Schema = import_zod58.z.object({
  pagesOrder: import_zod58.z.array(PageUidSchema).default([])
});

// src/models/entity.v3.schema.ts
var EntityBaseV3Schema = import_zod59.z.object({
  uid: EntityUidSchema,
  displayName: import_zod59.z.string().optional(),
  description: import_zod59.z.string().optional(),
  tagsUid: import_zod59.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod59.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var CharacterEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod59.z.literal("character")
});
var CreatureEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod59.z.literal("creature")
});
var GroupEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod59.z.literal("group"),
  ranks: import_zod59.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod59.z.array(EntityUidSchema).default([])
});
var PlaceEntityV3Schema = EntityBaseV3Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod59.z.literal("place") });
var ItemEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod59.z.literal("item")
});
var NoteEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod59.z.literal("note")
});
var AbilityEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod59.z.literal("ability")
});
var StoryEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod59.z.literal("story")
});
var EventEntityV3Schema = EntityBaseV3Schema.extend({
  type: import_zod59.z.literal("event")
});
var EntityV3Schema = import_zod59.z.discriminatedUnion("type", [
...
var EntityV4Schema = import_zod60.z.discriminatedUnion("type", [
...
var EntityBaseV6Schema = EntityBaseV4Schema.extend({
  actions: import_zod61.z.array(EntityActionV2Schema).default([])
});
...
var EntityV6Schema = import_zod61.z.discriminatedUnion("type", [
...
var EntitySpawnV1Schema = import_zod62.z.object({
  uid: EntitySpawnUidSchema,
  entityUid: EntityUidSchema,
  ownerUid: EntityUidSchema.optional(),
  label: import_zod62.z.string().optional()
}).merge(WithDataV1Schema);

// src/models/random-table.v7.schema.ts
var import_zod63 = require("zod");
var RandomTableRowV7Schema = import_zod63.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod63.z.number().default(1),
  content: import_zod63.z.string(),
  randomTableRefs: import_zod63.z.record(RandomTableUidSchema).optional()
});
var RandomTableV7Schema = import_zod63.z.object({
  uid: RandomTableUidSchema,
  title: import_zod63.z.string(),
  rows: import_zod63.z.array(RandomTableRowV7Schema).default([]),
  diceFormula: import_zod63.z.string().optional()
});

// src/models/requirement.v1.schema.ts
var import_zod64 = require("zod");
var ByppFileUrlV1Schema = import_zod64.z.string().url().refine(
  (url) => {
    try {
...
var RequirementSourceV1Schema = import_zod64.z.object({
  byppUrl: ByppFileUrlV1Schema,
  bundleName: import_zod64.z.string().optional(),
  bundleVersion: import_zod64.z.string().optional()
});
var RequirementV1Schema = import_zod64.z.object({
  category: import_zod64.z.string(),
  uid: import_zod64.z.string(),
...
var SceneV2Schema = import_zod65.z.object({ uid: SceneUidSchema }).merge(WithNameV1Schema).extend({
  mapUid: SceneMapUidSchema.optional(),
  backgroundUid: SceneBackgroundUidSchema.optional(),
  lightPositionX: import_zod65.z.number().optional(),
  lightPositionY: import_zod65.z.number().optional(),
  lightPositionZ: import_zod65.z.number().optional(),
  lightIntensity: import_zod65.z.number().optional(),
  lightColor: import_zod65.z.string().optional(),
  useCustomLightPosition: import_zod65.z.boolean().optional(),
  indoorLight: import_zod65.z.boolean().optional()
});
...
var SceneBackgroundBaseV2Schema = import_zod66.z.object({ uid: SceneBackgroundUidSchema }).merge(WithNameV1Schema).extend({
  opacity: import_zod66.z.number().optional()
});
var CustomImageSceneBackgroundV2Schema = SceneBackgroundBaseV2Schema.merge(WithImagesUrlsV2Schema).extend({
  type: import_zod66.z.literal("customImage")
});
var CustomVideoSceneBackgroundV2Schema = SceneBackgroundBaseV2Schema.merge(WithVideoUrlsV2Schema).extend({
  type: import_zod66.z.literal("customVideo")
});
var SceneBackgroundV2Schema = import_zod66.z.discriminatedUnion("type", [
...
var SceneBackgroundV3Schema = import_zod67.z.discriminatedUnion("type", [
...
var SceneBackgroundV4Schema = import_zod68.z.discriminatedUnion("type", [
...
var SceneMapBaseV2Schema = import_zod69.z.object({ uid: SceneMapUidSchema }).merge(WithNameV1Schema).extend({
  grid: GridDataV1Schema,
  sourceFormat: import_zod69.z.string().optional()
});
var CustomImageSceneMapV2Schema = SceneMapBaseV2Schema.merge(
  WithImagesUrlsV2Schema
).extend({
  type: import_zod69.z.literal("customImage")
});
var CustomVideoSceneMapV2Schema = SceneMapBaseV2Schema.merge(
  WithVideoUrlsV2Schema
).extend({
  type: import_zod69.z.literal("customVideo")
});
var SceneMapV2Schema = import_zod69.z.discriminatedUnion("type", [
...
var SceneMapV3Schema = import_zod70.z.discriminatedUnion("type", [
...
var SceneMapV4Schema = import_zod71.z.discriminatedUnion("type", [
...
var ObjectFitV6Schema = import_zod72.z.enum([
  "cover",
  "contain",
  "fill",
  "none",
...
var WidgetBackgroundV6Schema = import_zod72.z.object({
  assetUid: AssetUidSchema,
  objectFit: ObjectFitV6Schema.optional()
});
var StyleV2Schema = import_zod72.z.object({
  justifyContent: import_zod72.z.string().optional(),
  alignItems: import_zod72.z.string().optional(),
  flexDirection: import_zod72.z.string().optional(),
  lineHeight: import_zod72.z.number().optional(),
  fontFamilyId: import_zod72.z.string().optional(),
  fontScale: import_zod72.z.number().optional(),
  color: import_zod72.z.string().optional(),
  paddingTop: import_zod72.z.number().optional(),
  paddingRight: import_zod72.z.number().optional(),
  paddingBottom: import_zod72.z.number().optional(),
  paddingLeft: import_zod72.z.number().optional(),
  // New in v2:
  borderWidth: import_zod72.z.number().optional(),
  borderStyle: import_zod72.z.string().optional(),
  borderColor: import_zod72.z.string().optional(),
  borderRadius: import_zod72.z.string().optional(),
  background: WidgetBackgroundV6Schema.optional()
}).nullable().optional();
var WithStyleV2Schema = import_zod72.z.object({
  style: StyleV2Schema
});

// src/mixins/with-style.v3.schema.ts
var StyleV3Schema = StyleV2Schema.unwrap().unwrap().extend({
  rotation: import_zod73.z.number().optional()
}).nullable().optional();
var WithStyleV3Schema = import_zod73.z.object({
  style: StyleV3Schema
});
...
var SheetV3Schema = import_zod74.z.object({ uid: SheetUidSchema }).merge(WithImagesUrlsV2Schema).extend({
  name: import_zod74.z.string().optional(),
  widgetUids: import_zod74.z.array(WidgetUidSchema).default([]),
  compatibleDatasetUid: DatasetUidSchema.optional()
});

// src/models/sheet.v4.schema.ts
var SheetV4Schema = SheetV3Schema.extend({
  styles: import_zod75.z.record(import_zod75.z.string(), StyleV2Schema).optional()
});

// src/models/sheet.v5.schema.ts
var SheetV5Schema = SheetV4Schema.extend({
  styles: import_zod76.z.record(import_zod76.z.string(), StyleV3Schema).optional()
});
...
var TagV2Schema = import_zod77.z.object({ uid: TagUidSchema }).merge(WithNameV1Schema).extend({
  categoryUid: TagCategoryUidSchema.optional(),
  useAsFolder: import_zod77.z.boolean().default(false)
});
...
var StyleV4Schema = StyleV3Schema.unwrap().unwrap().extend({
  fontWeight: import_zod78.z.string().optional(),
  fontStyle: import_zod78.z.string().optional()
}).nullable().optional();
var WithStyleV4Schema = import_zod78.z.object({
  style: StyleV4Schema
});

// src/mixins/with-style.v5.schema.ts
var StyleV5Schema = StyleV4Schema.unwrap().unwrap().extend({
  marginTop: import_zod79.z.number().optional(),
  marginRight: import_zod79.z.number().optional(),
  marginBottom: import_zod79.z.number().optional(),
  marginLeft: import_zod79.z.number().optional(),
  backgroundColor: import_zod79.z.string().optional(),
  textDecoration: import_zod79.z.string().optional(),
  backgroundRepeat: import_zod79.z.boolean().optional()
}).nullable().optional();
var WithStyleV5Schema = import_zod79.z.object({
  style: StyleV5Schema
});

// src/mixins/with-style.v6.schema.ts
var SideV6Schema = import_zod80.z.number();
var SidesV6Schema = import_zod80.z.union([
  SideV6Schema,
  import_zod80.z.array(SideV6Schema).refine((sides) => sides.length === 2 || sides.length === 4, {
...
var WithStyleV6Schema = import_zod80.z.object({
  style: StyleV6Schema
});

// src/models/theme.v25.schema.ts
var ThemeStyleV25Schema = StyleV6Schema.unwrap().unwrap();
var ThemeTagStyleV25Schema = import_zod81.z.object({
  tagUid: TagUidSchema,
  style: ThemeStyleV25Schema
});
var ThemeV25Schema = import_zod81.z.object({
  slug: import_zod81.z.string().optional(),
  elements: import_zod81.z.record(import_zod81.z.string(), ThemeStyleV25Schema).default({}),
  tagStyles: import_zod81.z.array(ThemeTagStyleV25Schema).default([])
});
...
var EntitySpawnRefVariableV12Schema = EntityRefVariableV9Schema.merge(
  ...
  type: import_zod82.z.literal("entitySpawnRef")
});
var VariableV12Schema = import_zod82.z.discriminatedUnion("type", [
  NumberVariableV11Schema,
  TextVariableV11Schema,
  BooleanVariableV11Schema,
  ChoiceVariableV11Schema,
...
var EntityImageFormatV5Schema = import_zod83.z.enum(ENTITY_IMAGE_RENDITIONS);

// src/models/widget.v5.schema.ts
var EntityImageObjectFitV5Schema = import_zod84.z.enum([
  "contain",
  "cover",
  "fill",
  "none",
...
var WidgetEntityImageV5Schema = WidgetBaseV1Schema.extend({
  type: import_zod84.z.literal("entityImage"),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional()
});
var WidgetV5Schema = import_zod84.z.discriminatedUnion("type", [
  WidgetEmptyV1Schema,
  WidgetBigNumberV1Schema,
  WidgetPlainTextV1Schema,
  WidgetToggleV1Schema,
...
var WidgetV6Schema = import_zod85.z.discriminatedUnion("type", [
  WidgetEmptyV6Schema,
...
var WidgetWheelV7Schema = WidgetBaseV1Schema.merge(
  ...
  type: import_zod86.z.literal("wheel"),
  readingPosition: import_zod86.z.string().optional(),
  labelOrientation: import_zod86.z.string().optional(),
  radius: import_zod86.z.number().optional()
});
var WidgetV7Schema = import_zod86.z.discriminatedUnion("type", [
...
var WithWidgetActionsV8Schema = import_zod87.z.object({
  actionsVariablesUids: import_zod87.z.array(VariableUidSchema).optional()
});
var WidgetActionRollV8Schema = WidgetBaseV1Schema.merge(
  WithStyleV3Schema
).merge(WithWidgetActionsV8Schema).extend({
  type: import_zod87.z.literal("actionRoll")
});
var WidgetV8Schema = import_zod87.z.discriminatedUnion("type", [
...
var WidgetV9Schema = import_zod88.z.discriminatedUnion("type", [
...
var WidgetEntityGridV10Schema = WidgetBaseV1Schema.extend({
  type: import_zod89.z.literal("entityGrid"),
  gapX: import_zod89.z.number().optional(),
  gapY: import_zod89.z.number().optional(),
  listOptionStyle: import_zod89.z.string().optional(),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional(),
  imageWidth: import_zod89.z.number().optional(),
  imageHeight: import_zod89.z.number().optional()
}).merge(WithStyleV3Schema).merge(WithWidgetActionsV8Schema).merge(WithCreditV1Schema);
var WidgetV10Schema = import_zod89.z.discriminatedUnion("type", [
  ...WidgetV9Schema.options,
  WidgetEntityGridV10Schema
]);

// src/models/widget.v13.schema.ts
var WidgetV13Schema = import_zod90.z.discriminatedUnion("type", [
...
var DialectFontV2Schema = import_zod91.z.object({
  fontFamily: import_zod91.z.string(),
  fontUrl: import_zod91.z.string().url()
});
var DialectV2Schema = import_zod91.z.object({
  uid: DialectUidSchema,
  name: import_zod91.z.string(),
  font: DialectFontV2Schema,
  order: import_zod91.z.number().optional(),
  spokenByEntitiesUids: import_zod91.z.array(EntityUidSchema).default([])
});

// src/models/entity.v2.schema.ts
var import_zod92 = require("zod");
var EntityBaseV2Schema = import_zod92.z.object({
  uid: EntityUidSchema,
  displayName: import_zod92.z.string().optional(),
  description: import_zod92.z.string().optional(),
  tagsUid: import_zod92.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod92.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var CharacterEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod92.z.literal("character")
});
var CreatureEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod92.z.literal("creature")
});
var GroupEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod92.z.literal("group"),
  ranks: import_zod92.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod92.z.array(EntityUidSchema).default([])
});
var PlaceEntityV2Schema = EntityBaseV2Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod92.z.literal("place") });
var ItemEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod92.z.literal("item")
});
var NoteEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod92.z.literal("note")
});
var AbilityEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod92.z.literal("ability")
});
var StoryEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod92.z.literal("story")
});
var EventEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod92.z.literal("event")
});
var EntityV2Schema = import_zod92.z.discriminatedUnion("type", [
...
var RandomTableRowV2Schema = import_zod93.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod93.z.number().default(1),
  content: import_zod93.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV2Schema = import_zod93.z.object({
  uid: RandomTableUidSchema,
  title: import_zod93.z.string(),
  rows: import_zod93.z.array(RandomTableRowV2Schema).default([])
});

// src/schemas/bypp.v4.schema.ts
var ParentAttributionV4Schema = import_zod94.z.object({
  bundleName: import_zod94.z.string().min(1),
  authorName: import_zod94.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod94.z.string().url().optional()
});
var BeyondPaperV4Schema = import_zod94.z.object({
  // Format metadata
  version: import_zod94.z.literal(4),
  ...
  variables: import_zod94.z.array(VariableV2Schema).default([]),
  widgets: import_zod94.z.array(WidgetV1Schema).default([]),
  sheets: import_zod94.z.array(SheetV3Schema).default([]),
  dataTables: import_zod94.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod94.z.array(RandomTableV2Schema).default([]),
...
// src/schemas/bypp.v28.schema.ts
var BeyondPaperV28Schema = import_zod95.z.object({
  // Format metadata
  version: import_zod95.z.literal(28),
  ...
  requires: import_zod95.z.array(RequirementV1Schema).default([]),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod95.z.array(DialectV3Schema).default([]),
  entities: import_zod95.z.array(EntityV6Schema).default([]),
  // Copies of entities, each over its model (see `entity-spawn.v1.schema`).
  // Absent from every document produced before v28.
  entitySpawns: import_zod95.z.array(EntitySpawnV1Schema).default([]),
  pages: import_zod95.z.array(PageV1Schema).default([]),
  chunks: import_zod95.z.array(ChunkV12Schema).default([]),
  datasets: import_zod95.z.array(DatasetV2Schema).default([]),
  variables: import_zod95.z.array(VariableV12Schema).default([]),
  widgets: import_zod95.z.array(WidgetV13Schema).default([]),
  sheets: import_zod95.z.array(SheetV7Schema).default([]),
  dataTables: import_zod95.z.array(DataTableV4Schema).default([]),
  randomTables: import_zod95.z.array(RandomTableV7Schema).default([]),
  tags: import_zod95.z.array(TagV3Schema).default([]),
  tagCategories: import_zod95.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod95.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod95.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod95.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod95.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v1.schema.ts
var import_zod96 = require("zod");
var BeyondPaperV1Schema = import_zod96.z.object({
  // Format metadata
  version: import_zod96.z.literal(1),
  ...
  // Content
  dialects: import_zod96.z.array(DialectV1Schema),
  entities: import_zod96.z.array(EntityV1Schema),
  pages: import_zod96.z.array(PageV1Schema),
  chunks: import_zod96.z.array(ChunkV1Schema),
  datasets: import_zod96.z.array(DatasetV1Schema),
  variables: import_zod96.z.array(VariableV1Schema),
  widgets: import_zod96.z.array(WidgetV1Schema),
  randomTables: import_zod96.z.array(RandomTableV1Schema),
  tags: import_zod96.z.array(TagV1Schema),
  tagCategories: import_zod96.z.array(TagCategoryV1Schema),
  scenes: import_zod96.z.array(SceneV1Schema),
  sceneMaps: import_zod96.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod96.z.array(SceneBackgroundV1Schema),
  assets: import_zod96.z.array(AssetV1Schema)
});

// src/schemas/bypp.v2.schema.ts
var import_zod97 = require("zod");
var BeyondPaperV2Schema = import_zod97.z.object({
  // Format metadata
  version: import_zod97.z.literal(2),
  ...
  variables: import_zod97.z.array(VariableV2Schema),
  widgets: import_zod97.z.array(WidgetV1Schema),
  sheets: import_zod97.z.array(SheetV2Schema),
  dataTables: import_zod97.z.array(DataTableV2Schema),
...
var BeyondPaperV5Schema = import_zod98.z.object({
  // Format metadata
  version: import_zod98.z.literal(5),
  ...
  entities: import_zod98.z.array(EntityV2Schema).default([]),
  pages: import_zod98.z.array(PageV1Schema).default([]),
  chunks: import_zod98.z.array(ChunkV2Schema).default([]),
  datasets: import_zod98.z.array(DatasetV2Schema).default([]),
  variables: import_zod98.z.array(VariableV5Schema).default([]),
  widgets: import_zod98.z.array(WidgetV5Schema).default([]),
  sheets: import_zod98.z.array(SheetV3Schema).default([]),
  dataTables: import_zod98.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod98.z.array(RandomTableV2Schema).default([]),
  ...
  sceneMaps: import_zod98.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod98.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod98.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v6.schema.ts
var import_zod99 = require("zod");
var BeyondPaperV6Schema = import_zod99.z.object({
  // Format metadata
  version: import_zod99.z.literal(6),
  ...
  variables: import_zod99.z.array(VariableV6Schema).default([]),
...
var BeyondPaperV7Schema = import_zod100.z.object({
  // Format metadata
  version: import_zod100.z.literal(7),
...
var BeyondPaperV8Schema = import_zod101.z.object({
  // Format metadata
  version: import_zod101.z.literal(8),
  ...
  widgets: import_zod101.z.array(WidgetV6Schema).default([]),
  sheets: import_zod101.z.array(SheetV4Schema).default([]),
...
var BeyondPaperV9Schema = import_zod102.z.object({
  // Format metadata
  version: import_zod102.z.literal(9),
  ...
  variables: import_zod102.z.array(VariableV7Schema).default([]),
  widgets: import_zod102.z.array(WidgetV7Schema).default([]),
  sheets: import_zod102.z.array(SheetV5Schema).default([]),
...
var BeyondPaperV10Schema = import_zod103.z.object({
  // Format metadata
  version: import_zod103.z.literal(10),
  ...
  entities: import_zod103.z.array(EntityV3Schema).default([]),
  ...
  sheets: import_zod103.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod103.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod103.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod103.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v11.schema.ts
var import_zod104 = require("zod");
var BeyondPaperV11Schema = import_zod104.z.object({
  // Format metadata
  version: import_zod104.z.literal(11),
...
var BeyondPaperV12Schema = import_zod105.z.object({
  // Format metadata
  version: import_zod105.z.literal(12),
  ...
  widgets: import_zod105.z.array(WidgetV8Schema).default([]),
...
var BeyondPaperV13Schema = import_zod106.z.object({
  // Format metadata
  version: import_zod106.z.literal(13),
  ...
  entities: import_zod106.z.array(EntityV4Schema).default([]),
  ...
  widgets: import_zod106.z.array(WidgetV9Schema).default([]),
...
var BeyondPaperV14Schema = import_zod107.z.object({
  // Format metadata
  version: import_zod107.z.literal(14),
...
var BeyondPaperV15Schema = import_zod108.z.object({
  // Format metadata
  version: import_zod108.z.literal(15),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod108.z.array(DialectV3Schema).default([]),
...
var BeyondPaperV16Schema = import_zod109.z.object({
  // Format metadata
  version: import_zod109.z.literal(16),
  ...
  variables: import_zod109.z.array(VariableV8Schema).default([]),
...
var BeyondPaperV17Schema = import_zod110.z.object({
  // Format metadata
  version: import_zod110.z.literal(17),
  ...
  tags: import_zod110.z.array(TagV3Schema).default([]),
  tagCategories: import_zod110.z.array(TagCategoryV2Schema).default([]),
...
var BeyondPaperV18Schema = import_zod111.z.object({
  // Format metadata
  version: import_zod111.z.literal(18),
  ...
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod111.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
...
var BeyondPaperV19Schema = import_zod112.z.object({
  // Format metadata
  version: import_zod112.z.literal(19),
  ...
  variables: import_zod112.z.array(VariableV9Schema).default([]),
  widgets: import_zod112.z.array(WidgetV10Schema).default([]),
...
var EntityActionV1Schema = import_zod113.z.object({
  uid: EntityActionUidSchema,
  label: TranslatableTextV2Schema,
  visual: ActionVisualV1Schema.optional(),
  hue: import_zod113.z.number().nullable().optional(),
  type: import_zod113.z.literal("roll"),
  diceFormula: import_zod113.z.string().optional()
});

// src/models/entity.v5.schema.ts
var EntityBaseV5Schema = EntityBaseV4Schema.extend({
  actions: import_zod114.z.array(EntityActionV1Schema).default([])
});
var CharacterEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod114.z.literal("character")
});
var CreatureEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod114.z.literal("creature")
});
var GroupEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod114.z.literal("group"),
  ranks: import_zod114.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod114.z.array(EntityUidSchema).default([])
});
var PlaceEntityV5Schema = EntityBaseV5Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod114.z.literal("place") });
var ItemEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod114.z.literal("item")
});
var NoteEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod114.z.literal("note")
});
var AbilityEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod114.z.literal("ability")
});
var StoryEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod114.z.literal("story")
});
var EventEntityV5Schema = EntityBaseV5Schema.extend({
  type: import_zod114.z.literal("event")
});
var EntityV5Schema = import_zod114.z.discriminatedUnion("type", [
...
// src/schemas/bypp.v20.schema.ts
var BeyondPaperV20Schema = import_zod115.z.object({
  // Format metadata
  version: import_zod115.z.literal(20),
  format: import_zod115.z.literal("bypp"),
  // Bundle metadata
  name: import_zod115.z.string(),
  exportedAt: import_zod115.z.string(),
  bundleVersion: import_zod115.z.string(),
  // The bundle's cover. Optional: a bundle with no cover simply omits it,
  // and so does every document produced before v14.
  image: BundleImageV14Schema.optional(),
  // Licensing & attribution
  license: CcLicenseV3Schema,
  licenseVersion: import_zod115.z.literal("4.0"),
  attribution: AttributionV3Schema,
  parentAttribution: ParentAttributionV4Schema.optional(),
  creatorLinks: import_zod115.z.array(import_zod115.z.string().url()).optional(),
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod115.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod115.z.array(DialectV3Schema).default([]),
  entities: import_zod115.z.array(EntityV5Schema).default([]),
  pages: import_zod115.z.array(PageV1Schema).default([]),
  chunks: import_zod115.z.array(ChunkV11Schema).default([]),
  datasets: import_zod115.z.array(DatasetV2Schema).default([]),
  variables: import_zod115.z.array(VariableV9Schema).default([]),
  widgets: import_zod115.z.array(WidgetV10Schema).default([]),
  sheets: import_zod115.z.array(SheetV7Schema).default([]),
  dataTables: import_zod115.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod115.z.array(RandomTableV7Schema).default([]),
  tags: import_zod115.z.array(TagV3Schema).default([]),
  tagCategories: import_zod115.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod115.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod115.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod115.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod115.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v21.schema.ts
var import_zod116 = require("zod");
var BeyondPaperV21Schema = import_zod116.z.object({
  // Format metadata
  version: import_zod116.z.literal(21),
  ...
  chunks: import_zod116.z.array(ChunkV12Schema).default([]),
...
var WidgetV11Schema = import_zod117.z.discriminatedUnion("type", [
...
// src/schemas/bypp.v22.schema.ts
var BeyondPaperV22Schema = import_zod118.z.object({
  // Format metadata
  version: import_zod118.z.literal(22),
  format: import_zod118.z.literal("bypp"),
  // Bundle metadata
  name: import_zod118.z.string(),
  exportedAt: import_zod118.z.string(),
  bundleVersion: import_zod118.z.string(),
  // The bundle's cover. Optional: a bundle with no cover simply omits it,
  // and so does every document produced before v14.
  image: BundleImageV14Schema.optional(),
  // Licensing & attribution
  license: CcLicenseV3Schema,
  licenseVersion: import_zod118.z.literal("4.0"),
  attribution: AttributionV3Schema,
  parentAttribution: ParentAttributionV4Schema.optional(),
  creatorLinks: import_zod118.z.array(import_zod118.z.string().url()).optional(),
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod118.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod118.z.array(DialectV3Schema).default([]),
  entities: import_zod118.z.array(EntityV5Schema).default([]),
  pages: import_zod118.z.array(PageV1Schema).default([]),
  chunks: import_zod118.z.array(ChunkV12Schema).default([]),
  datasets: import_zod118.z.array(DatasetV2Schema).default([]),
  variables: import_zod118.z.array(VariableV9Schema).default([]),
  widgets: import_zod118.z.array(WidgetV11Schema).default([]),
  sheets: import_zod118.z.array(SheetV7Schema).default([]),
  dataTables: import_zod118.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod118.z.array(RandomTableV7Schema).default([]),
  tags: import_zod118.z.array(TagV3Schema).default([]),
  tagCategories: import_zod118.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod118.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod118.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod118.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod118.z.array(AssetV3Schema).default([])
});
...
var WidgetV12Schema = import_zod119.z.discriminatedUnion("type", [
...
// src/schemas/bypp.v23.schema.ts
var BeyondPaperV23Schema = import_zod120.z.object({
  // Format metadata
  version: import_zod120.z.literal(23),
  format: import_zod120.z.literal("bypp"),
  // Bundle metadata
  name: import_zod120.z.string(),
  exportedAt: import_zod120.z.string(),
  bundleVersion: import_zod120.z.string(),
  // The bundle's cover. Optional: a bundle with no cover simply omits it,
  // and so does every document produced before v14.
  image: BundleImageV14Schema.optional(),
  // Licensing & attribution
  license: CcLicenseV3Schema,
  licenseVersion: import_zod120.z.literal("4.0"),
  attribution: AttributionV3Schema,
  parentAttribution: ParentAttributionV4Schema.optional(),
  creatorLinks: import_zod120.z.array(import_zod120.z.string().url()).optional(),
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod120.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod120.z.array(DialectV3Schema).default([]),
  entities: import_zod120.z.array(EntityV5Schema).default([]),
  pages: import_zod120.z.array(PageV1Schema).default([]),
  chunks: import_zod120.z.array(ChunkV12Schema).default([]),
  datasets: import_zod120.z.array(DatasetV2Schema).default([]),
  variables: import_zod120.z.array(VariableV9Schema).default([]),
  widgets: import_zod120.z.array(WidgetV12Schema).default([]),
  sheets: import_zod120.z.array(SheetV7Schema).default([]),
  dataTables: import_zod120.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod120.z.array(RandomTableV7Schema).default([]),
  tags: import_zod120.z.array(TagV3Schema).default([]),
  tagCategories: import_zod120.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod120.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod120.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod120.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod120.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v24.schema.ts
var import_zod121 = require("zod");
var BeyondPaperV24Schema = import_zod121.z.object({
  // Format metadata
  version: import_zod121.z.literal(24),
  ...
  widgets: import_zod121.z.array(WidgetV13Schema).default([]),
...
var BeyondPaperV25Schema = import_zod122.z.object({
  // Format metadata
  version: import_zod122.z.literal(25),
...
var BeyondPaperV26Schema = import_zod123.z.object({
  // Format metadata
  version: import_zod123.z.literal(26),
  ...
  entities: import_zod123.z.array(EntityV6Schema).default([]),
  ...
  variables: import_zod123.z.array(VariableV10Schema).default([]),
...
var BeyondPaperV27Schema = import_zod124.z.object({
  // Format metadata
  version: import_zod124.z.literal(27),
  ...
  variables: import_zod124.z.array(VariableV11Schema).default([]),
  widgets: import_zod124.z.array(WidgetV13Schema).default([]),
  sheets: import_zod124.z.array(SheetV7Schema).default([]),
  dataTables: import_zod124.z.array(DataTableV4Schema).default([]),
