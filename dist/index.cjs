...
var DialectV3Schema = import_zod44.z.object({
  uid: DialectUidSchema,
  name: import_zod44.z.string(),
  fontFamily: import_zod44.z.string().optional(),
...
var EntityActionV1Schema = import_zod46.z.object({
  uid: EntityActionUidSchema,
  label: TranslatableTextV2Schema,
  visual: ActionVisualV1Schema.optional(),
  hue: import_zod46.z.number().nullable().optional(),
  type: import_zod46.z.literal("roll"),
  diceFormula: import_zod46.z.string().optional()
});
...
var WithArchiveV2Schema = import_zod47.z.object({
  isArchived: import_zod47.z.boolean().default(false)
});

// src/mixins/with-pages.v2.schema.ts
var import_zod48 = require("zod");
var WithPagesV2Schema = import_zod48.z.object({
  pagesOrder: import_zod48.z.array(PageUidSchema).default([])
});

// src/models/entity.v3.schema.ts
var EntityBaseV3Schema = import_zod49.z.object({
  uid: EntityUidSchema,
  displayName: import_zod49.z.string().optional(),
  description: import_zod49.z.string().optional(),
  tagsUid: import_zod49.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod49.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var EntityV3Schema = import_zod49.z.discriminatedUnion("type", [
...
var EntityV4Schema = import_zod50.z.discriminatedUnion("type", [
...
var EntityBaseV5Schema = EntityBaseV4Schema.extend({
  actions: import_zod51.z.array(EntityActionV1Schema).default([])
});
...
var EntityV5Schema = import_zod51.z.discriminatedUnion("type", [
...
var RandomTableRowV7Schema = import_zod52.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod52.z.number().default(1),
  content: import_zod52.z.string(),
  randomTableRefs: import_zod52.z.record(RandomTableUidSchema).optional()
});
var RandomTableV7Schema = import_zod52.z.object({
  uid: RandomTableUidSchema,
  title: import_zod52.z.string(),
  rows: import_zod52.z.array(RandomTableRowV7Schema).default([]),
  diceFormula: import_zod52.z.string().optional()
});

// src/models/requirement.v1.schema.ts
var import_zod53 = require("zod");
var ByppFileUrlV1Schema = import_zod53.z.string().url().refine(
  (url) => {
    try {
...
var RequirementSourceV1Schema = import_zod53.z.object({
  byppUrl: ByppFileUrlV1Schema,
  bundleName: import_zod53.z.string().optional(),
  bundleVersion: import_zod53.z.string().optional()
});
var RequirementV1Schema = import_zod53.z.object({
  category: import_zod53.z.string(),
  uid: import_zod53.z.string(),
...
var SceneV2Schema = import_zod54.z.object({ uid: SceneUidSchema }).merge(WithNameV1Schema).extend({
  mapUid: SceneMapUidSchema.optional(),
  backgroundUid: SceneBackgroundUidSchema.optional(),
  lightPositionX: import_zod54.z.number().optional(),
  lightPositionY: import_zod54.z.number().optional(),
  lightPositionZ: import_zod54.z.number().optional(),
  lightIntensity: import_zod54.z.number().optional(),
  lightColor: import_zod54.z.string().optional(),
  useCustomLightPosition: import_zod54.z.boolean().optional(),
  indoorLight: import_zod54.z.boolean().optional()
});
...
var SceneBackgroundBaseV2Schema = import_zod55.z.object({ uid: SceneBackgroundUidSchema }).merge(WithNameV1Schema).extend({
  opacity: import_zod55.z.number().optional()
});
...
var SceneBackgroundV2Schema = import_zod55.z.discriminatedUnion("type", [
...
var SceneBackgroundV3Schema = import_zod56.z.discriminatedUnion("type", [
...
var SceneBackgroundV4Schema = import_zod57.z.discriminatedUnion("type", [
...
var SceneMapBaseV2Schema = import_zod58.z.object({ uid: SceneMapUidSchema }).merge(WithNameV1Schema).extend({
  grid: GridDataV1Schema,
  sourceFormat: import_zod58.z.string().optional()
});
var CustomImageSceneMapV2Schema = SceneMapBaseV2Schema.merge(
  WithImagesUrlsV2Schema
).extend({
  type: import_zod58.z.literal("customImage")
});
var CustomVideoSceneMapV2Schema = SceneMapBaseV2Schema.merge(
  WithVideoUrlsV2Schema
).extend({
  type: import_zod58.z.literal("customVideo")
});
var SceneMapV2Schema = import_zod58.z.discriminatedUnion("type", [
...
var SceneMapV3Schema = import_zod59.z.discriminatedUnion("type", [
...
var SceneMapV4Schema = import_zod60.z.discriminatedUnion("type", [
...
var ObjectFitV6Schema = import_zod61.z.enum([
  "cover",
  "contain",
  "fill",
  "none",
...
var WidgetBackgroundV6Schema = import_zod61.z.object({
  assetUid: AssetUidSchema,
  objectFit: ObjectFitV6Schema.optional()
});
var StyleV2Schema = import_zod61.z.object({
  justifyContent: import_zod61.z.string().optional(),
  alignItems: import_zod61.z.string().optional(),
  flexDirection: import_zod61.z.string().optional(),
  lineHeight: import_zod61.z.number().optional(),
  fontFamilyId: import_zod61.z.string().optional(),
  fontScale: import_zod61.z.number().optional(),
  color: import_zod61.z.string().optional(),
  paddingTop: import_zod61.z.number().optional(),
  paddingRight: import_zod61.z.number().optional(),
  paddingBottom: import_zod61.z.number().optional(),
  paddingLeft: import_zod61.z.number().optional(),
  // New in v2:
  borderWidth: import_zod61.z.number().optional(),
  borderStyle: import_zod61.z.string().optional(),
  borderColor: import_zod61.z.string().optional(),
  borderRadius: import_zod61.z.string().optional(),
  background: WidgetBackgroundV6Schema.optional()
}).nullable().optional();
var WithStyleV2Schema = import_zod61.z.object({
  style: StyleV2Schema
});

// src/mixins/with-style.v3.schema.ts
var StyleV3Schema = StyleV2Schema.unwrap().unwrap().extend({
  rotation: import_zod62.z.number().optional()
}).nullable().optional();
var WithStyleV3Schema = import_zod62.z.object({
  style: StyleV3Schema
});
...
var SheetV3Schema = import_zod63.z.object({ uid: SheetUidSchema }).merge(WithImagesUrlsV2Schema).extend({
  name: import_zod63.z.string().optional(),
  widgetUids: import_zod63.z.array(WidgetUidSchema).default([]),
  compatibleDatasetUid: DatasetUidSchema.optional()
});

// src/models/sheet.v4.schema.ts
var SheetV4Schema = SheetV3Schema.extend({
  styles: import_zod64.z.record(import_zod64.z.string(), StyleV2Schema).optional()
});

// src/models/sheet.v5.schema.ts
var SheetV5Schema = SheetV4Schema.extend({
  styles: import_zod65.z.record(import_zod65.z.string(), StyleV3Schema).optional()
});
...
var WithIconV1Schema = import_zod66.z.object({
  icon: import_zod66.z.string().optional()
});

// src/models/tag.v2.schema.ts
var import_zod67 = require("zod");
var TagV2Schema = import_zod67.z.object({ uid: TagUidSchema }).merge(WithNameV1Schema).extend({
  categoryUid: TagCategoryUidSchema.optional(),
  useAsFolder: import_zod67.z.boolean().default(false)
});
...
var ImageVariableV5Schema = VariableBaseV1Schema.extend({
  type: import_zod68.z.literal("image")
});
var VariableV5Schema = import_zod68.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var DataTableDirectLookupVariableV6Schema = VariableBaseV1Schema.extend(
  {
    type: import_zod69.z.literal("dataTableDirectLookup"),
    dataTableUid: DataTableUidSchema.optional(),
    columnUid: DataTableColumnUidSchema.optional(),
    rowUids: import_zod69.z.array(DataTableRowUidSchema).optional(),
    chainedLabelColumnUids: import_zod69.z.array(DataTableColumnUidSchema).optional(),
    multiAggregator: import_zod69.z.enum(["concat", "sum", "avg", "min", "max"]).optional(),
    multiSeparator: import_zod69.z.string().optional()
  }
);
var VariableV6Schema = import_zod69.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var NumberVariableV2Schema = NumberVariableV1Schema.extend({
  min: import_zod70.z.number().optional(),
  max: import_zod70.z.number().optional(),
  step: import_zod70.z.number().optional()
});
var VariableV7Schema = import_zod70.z.discriminatedUnion("type", [
...
var VariableV8Schema = import_zod71.z.discriminatedUnion("type", [
...
var EntityRefVariableV9Schema = VariableBaseV8Schema.extend({
  type: import_zod72.z.literal("entityRef"),
  sourceVariableUid: VariableUidSchema.optional(),
  targetsTypes: import_zod72.z.array(import_zod72.z.string()).optional(),
  targetsTags: import_zod72.z.array(TagUidSchema).optional(),
  targetTagsGroup: import_zod72.z.enum(["every", "some"]).optional(),
  max: import_zod72.z.number().optional(),
  maxVariable: VariableUidSchema.nullable().optional()
});
var EntityLookupVariableV9Schema = VariableBaseV8Schema.extend({
  type: import_zod72.z.literal("entityLookup"),
  sourceVariableUid: VariableUidSchema.optional(),
  keyVariableUid: VariableUidSchema.optional(),
  labelVariableUid: VariableUidSchema.optional(),
  multiAggregator: import_zod72.z.enum(["concat", "sum", "avg", "min", "max"]).optional(),
  multiSeparator: import_zod72.z.string().optional()
});
var VariableV9Schema = import_zod72.z.discriminatedUnion("type", [
  NumberVariableV8Schema,
  TextVariableV8Schema,
  BooleanVariableV8Schema,
  ChoiceVariableV8Schema,
...
var EntityImageFormatV5Schema = import_zod73.z.enum(ENTITY_IMAGE_RENDITIONS);

// src/models/widget.v5.schema.ts
var import_zod74 = require("zod");
var EntityImageObjectFitV5Schema = import_zod74.z.enum([
  "contain",
  "cover",
  "fill",
  "none",
...
var WidgetEntityImageV5Schema = WidgetBaseV1Schema.extend({
  type: import_zod74.z.literal("entityImage"),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional()
});
var WidgetV5Schema = import_zod74.z.discriminatedUnion("type", [
  WidgetEmptyV1Schema,
  WidgetBigNumberV1Schema,
  WidgetPlainTextV1Schema,
  WidgetToggleV1Schema,
...
var WidgetV6Schema = import_zod75.z.discriminatedUnion("type", [
  WidgetEmptyV6Schema,
...
var WidgetWheelV7Schema = WidgetBaseV1Schema.merge(
  ...
  type: import_zod76.z.literal("wheel"),
  readingPosition: import_zod76.z.string().optional(),
  labelOrientation: import_zod76.z.string().optional(),
  radius: import_zod76.z.number().optional()
});
var WidgetV7Schema = import_zod76.z.discriminatedUnion("type", [
...
// src/models/widget.v8.schema.ts
var WithWidgetActionsV8Schema = import_zod77.z.object({
  actionsVariablesUids: import_zod77.z.array(VariableUidSchema).optional()
});
var WidgetActionRollV8Schema = WidgetBaseV1Schema.merge(
  WithStyleV3Schema
).merge(WithWidgetActionsV8Schema).extend({
  type: import_zod77.z.literal("actionRoll")
});
var WidgetV8Schema = import_zod77.z.discriminatedUnion("type", [
...
var WidgetV9Schema = import_zod78.z.discriminatedUnion("type", [
...
var WidgetEntityGridV10Schema = WidgetBaseV1Schema.extend({
  type: import_zod79.z.literal("entityGrid"),
  gapX: import_zod79.z.number().optional(),
  gapY: import_zod79.z.number().optional(),
  listOptionStyle: import_zod79.z.string().optional(),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional(),
  imageWidth: import_zod79.z.number().optional(),
  imageHeight: import_zod79.z.number().optional()
}).merge(WithStyleV3Schema).merge(WithWidgetActionsV8Schema).merge(WithCreditV1Schema);
var WidgetV10Schema = import_zod79.z.discriminatedUnion("type", [
...
var DialectFontV2Schema = import_zod80.z.object({
  fontFamily: import_zod80.z.string(),
  fontUrl: import_zod80.z.string().url()
});
var DialectV2Schema = import_zod80.z.object({
  uid: DialectUidSchema,
  name: import_zod80.z.string(),
  font: DialectFontV2Schema,
  order: import_zod80.z.number().optional(),
  spokenByEntitiesUids: import_zod80.z.array(EntityUidSchema).default([])
});

// src/models/entity.v2.schema.ts
var import_zod81 = require("zod");
var EntityBaseV2Schema = import_zod81.z.object({
  uid: EntityUidSchema,
  displayName: import_zod81.z.string().optional(),
  description: import_zod81.z.string().optional(),
  tagsUid: import_zod81.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod81.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var CharacterEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod81.z.literal("character")
});
var CreatureEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod81.z.literal("creature")
});
var GroupEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod81.z.literal("group"),
  ranks: import_zod81.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod81.z.array(EntityUidSchema).default([])
});
var PlaceEntityV2Schema = EntityBaseV2Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod81.z.literal("place") });
var ItemEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod81.z.literal("item")
});
var NoteEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod81.z.literal("note")
});
var AbilityEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod81.z.literal("ability")
});
var StoryEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod81.z.literal("story")
});
var EventEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod81.z.literal("event")
});
var EntityV2Schema = import_zod81.z.discriminatedUnion("type", [
...
var RandomTableRowV2Schema = import_zod82.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod82.z.number().default(1),
  content: import_zod82.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV2Schema = import_zod82.z.object({
  uid: RandomTableUidSchema,
  title: import_zod82.z.string(),
  rows: import_zod82.z.array(RandomTableRowV2Schema).default([])
});

// src/schemas/bypp.v4.schema.ts
var ParentAttributionV4Schema = import_zod83.z.object({
  bundleName: import_zod83.z.string().min(1),
  authorName: import_zod83.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod83.z.string().url().optional()
});
var BeyondPaperV4Schema = import_zod83.z.object({
  // Format metadata
  version: import_zod83.z.literal(4),
  ...
  variables: import_zod83.z.array(VariableV2Schema).default([]),
  widgets: import_zod83.z.array(WidgetV1Schema).default([]),
  sheets: import_zod83.z.array(SheetV3Schema).default([]),
  dataTables: import_zod83.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod83.z.array(RandomTableV2Schema).default([]),
...
// src/schemas/bypp.v20.schema.ts
var BeyondPaperV20Schema = import_zod84.z.object({
  // Format metadata
  version: import_zod84.z.literal(20),
  ...
  requires: import_zod84.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod84.z.array(DialectV3Schema).default([]),
  entities: import_zod84.z.array(EntityV5Schema).default([]),
  pages: import_zod84.z.array(PageV1Schema).default([]),
  chunks: import_zod84.z.array(ChunkV11Schema).default([]),
  datasets: import_zod84.z.array(DatasetV2Schema).default([]),
  variables: import_zod84.z.array(VariableV9Schema).default([]),
  widgets: import_zod84.z.array(WidgetV10Schema).default([]),
  sheets: import_zod84.z.array(SheetV7Schema).default([]),
  dataTables: import_zod84.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod84.z.array(RandomTableV7Schema).default([]),
  tags: import_zod84.z.array(TagV3Schema).default([]),
  tagCategories: import_zod84.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod84.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod84.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod84.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod84.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v1.schema.ts
var import_zod85 = require("zod");
var BeyondPaperV1Schema = import_zod85.z.object({
  // Format metadata
  version: import_zod85.z.literal(1),
  ...
  // Content
  dialects: import_zod85.z.array(DialectV1Schema),
  entities: import_zod85.z.array(EntityV1Schema),
  pages: import_zod85.z.array(PageV1Schema),
  chunks: import_zod85.z.array(ChunkV1Schema),
  datasets: import_zod85.z.array(DatasetV1Schema),
  variables: import_zod85.z.array(VariableV1Schema),
  widgets: import_zod85.z.array(WidgetV1Schema),
  randomTables: import_zod85.z.array(RandomTableV1Schema),
  tags: import_zod85.z.array(TagV1Schema),
  tagCategories: import_zod85.z.array(TagCategoryV1Schema),
  scenes: import_zod85.z.array(SceneV1Schema),
  sceneMaps: import_zod85.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod85.z.array(SceneBackgroundV1Schema),
  assets: import_zod85.z.array(AssetV1Schema)
});

// src/schemas/bypp.v2.schema.ts
var import_zod86 = require("zod");
var BeyondPaperV2Schema = import_zod86.z.object({
  // Format metadata
  version: import_zod86.z.literal(2),
  ...
  // Content
  dialects: import_zod86.z.array(DialectV1Schema),
  entities: import_zod86.z.array(EntityV1Schema),
  pages: import_zod86.z.array(PageV1Schema),
  chunks: import_zod86.z.array(ChunkV1Schema),
  datasets: import_zod86.z.array(DatasetV1Schema),
  variables: import_zod86.z.array(VariableV2Schema),
  widgets: import_zod86.z.array(WidgetV1Schema),
  sheets: import_zod86.z.array(SheetV2Schema),
  dataTables: import_zod86.z.array(DataTableV2Schema),
  randomTables: import_zod86.z.array(RandomTableV1Schema),
  tags: import_zod86.z.array(TagV1Schema),
  tagCategories: import_zod86.z.array(TagCategoryV1Schema),
  scenes: import_zod86.z.array(SceneV1Schema),
  sceneMaps: import_zod86.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod86.z.array(SceneBackgroundV1Schema),
  assets: import_zod86.z.array(AssetV1Schema)
});

// src/schemas/bypp.v5.schema.ts
var import_zod87 = require("zod");
var BeyondPaperV5Schema = import_zod87.z.object({
  // Format metadata
  version: import_zod87.z.literal(5),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod87.z.array(DialectV2Schema).default([]),
  entities: import_zod87.z.array(EntityV2Schema).default([]),
  pages: import_zod87.z.array(PageV1Schema).default([]),
  chunks: import_zod87.z.array(ChunkV2Schema).default([]),
  datasets: import_zod87.z.array(DatasetV2Schema).default([]),
  variables: import_zod87.z.array(VariableV5Schema).default([]),
  widgets: import_zod87.z.array(WidgetV5Schema).default([]),
  sheets: import_zod87.z.array(SheetV3Schema).default([]),
  dataTables: import_zod87.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod87.z.array(RandomTableV2Schema).default([]),
  tags: import_zod87.z.array(TagV2Schema).default([]),
  tagCategories: import_zod87.z.array(TagCategoryV1Schema).default([]),
  scenes: import_zod87.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod87.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod87.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod87.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v6.schema.ts
var import_zod88 = require("zod");
var BeyondPaperV6Schema = import_zod88.z.object({
  // Format metadata
  version: import_zod88.z.literal(6),
  ...
  // Licensing & attribution
  license: CcLicenseV3Schema,
  licenseVersion: import_zod88.z.literal("4.0"),
  attribution: AttributionV3Schema,
  parentAttribution: ParentAttributionV4Schema.optional(),
  creatorLinks: import_zod88.z.array(import_zod88.z.string().url()).optional(),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod88.z.array(DialectV2Schema).default([]),
  entities: import_zod88.z.array(EntityV2Schema).default([]),
  pages: import_zod88.z.array(PageV1Schema).default([]),
  chunks: import_zod88.z.array(ChunkV2Schema).default([]),
  datasets: import_zod88.z.array(DatasetV2Schema).default([]),
  variables: import_zod88.z.array(VariableV6Schema).default([]),
  widgets: import_zod88.z.array(WidgetV5Schema).default([]),
  sheets: import_zod88.z.array(SheetV3Schema).default([]),
  dataTables: import_zod88.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod88.z.array(RandomTableV2Schema).default([]),
  tags: import_zod88.z.array(TagV2Schema).default([]),
  tagCategories: import_zod88.z.array(TagCategoryV1Schema).default([]),
  scenes: import_zod88.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod88.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod88.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod88.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v7.schema.ts
var import_zod89 = require("zod");
var BeyondPaperV7Schema = import_zod89.z.object({
  // Format metadata
  version: import_zod89.z.literal(7),
  ...
  variables: import_zod89.z.array(VariableV6Schema).default([]),
  widgets: import_zod89.z.array(WidgetV5Schema).default([]),
  sheets: import_zod89.z.array(SheetV3Schema).default([]),
  dataTables: import_zod89.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod89.z.array(RandomTableV7Schema).default([]),
...
var BeyondPaperV8Schema = import_zod90.z.object({
  // Format metadata
  version: import_zod90.z.literal(8),
  ...
  variables: import_zod90.z.array(VariableV6Schema).default([]),
  widgets: import_zod90.z.array(WidgetV6Schema).default([]),
  sheets: import_zod90.z.array(SheetV4Schema).default([]),
...
var BeyondPaperV9Schema = import_zod91.z.object({
  // Format metadata
  version: import_zod91.z.literal(9),
  ...
  variables: import_zod91.z.array(VariableV7Schema).default([]),
  widgets: import_zod91.z.array(WidgetV7Schema).default([]),
  sheets: import_zod91.z.array(SheetV5Schema).default([]),
...
var BeyondPaperV10Schema = import_zod92.z.object({
  // Format metadata
  version: import_zod92.z.literal(10),
  ...
  entities: import_zod92.z.array(EntityV3Schema).default([]),
  ...
  variables: import_zod92.z.array(VariableV7Schema).default([]),
  widgets: import_zod92.z.array(WidgetV7Schema).default([]),
  sheets: import_zod92.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod92.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod92.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod92.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v11.schema.ts
var import_zod93 = require("zod");
var BeyondPaperV11Schema = import_zod93.z.object({
  // Format metadata
  version: import_zod93.z.literal(11),
  ...
  entities: import_zod93.z.array(EntityV3Schema).default([]),
  ...
  variables: import_zod93.z.array(VariableV7Schema).default([]),
  widgets: import_zod93.z.array(WidgetV7Schema).default([]),
  sheets: import_zod93.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod93.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod93.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod93.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v12.schema.ts
var import_zod94 = require("zod");
var BeyondPaperV12Schema = import_zod94.z.object({
  // Format metadata
  version: import_zod94.z.literal(12),
  ...
  entities: import_zod94.z.array(EntityV3Schema).default([]),
  pages: import_zod94.z.array(PageV1Schema).default([]),
  chunks: import_zod94.z.array(ChunkV11Schema).default([]),
  datasets: import_zod94.z.array(DatasetV2Schema).default([]),
  variables: import_zod94.z.array(VariableV7Schema).default([]),
  widgets: import_zod94.z.array(WidgetV8Schema).default([]),
  sheets: import_zod94.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod94.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod94.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod94.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v13.schema.ts
var import_zod95 = require("zod");
var BeyondPaperV13Schema = import_zod95.z.object({
  // Format metadata
  version: import_zod95.z.literal(13),
...
var BeyondPaperV14Schema = import_zod96.z.object({
  // Format metadata
  version: import_zod96.z.literal(14),
  ...
  entities: import_zod96.z.array(EntityV4Schema).default([]),
  ...
  widgets: import_zod96.z.array(WidgetV9Schema).default([]),
...
var BeyondPaperV15Schema = import_zod97.z.object({
  // Format metadata
  version: import_zod97.z.literal(15),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod97.z.array(DialectV3Schema).default([]),
  entities: import_zod97.z.array(EntityV4Schema).default([]),
  ...
  widgets: import_zod97.z.array(WidgetV9Schema).default([]),
  sheets: import_zod97.z.array(SheetV7Schema).default([]),
  ...
  sceneMaps: import_zod97.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod97.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod97.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v16.schema.ts
var import_zod98 = require("zod");
var BeyondPaperV16Schema = import_zod98.z.object({
  // Format metadata
  version: import_zod98.z.literal(16),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod98.z.array(DialectV3Schema).default([]),
  ...
  variables: import_zod98.z.array(VariableV8Schema).default([]),
...
var BeyondPaperV17Schema = import_zod99.z.object({
  // Format metadata
  version: import_zod99.z.literal(17),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod99.z.array(DialectV3Schema).default([]),
  ...
  variables: import_zod99.z.array(VariableV8Schema).default([]),
  ...
  tags: import_zod99.z.array(TagV3Schema).default([]),
  tagCategories: import_zod99.z.array(TagCategoryV2Schema).default([]),
...
var BeyondPaperV18Schema = import_zod100.z.object({
  // Format metadata
  version: import_zod100.z.literal(18),
  ...
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod100.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  ...
  variables: import_zod100.z.array(VariableV8Schema).default([]),
  ...
  tags: import_zod100.z.array(TagV3Schema).default([]),
  tagCategories: import_zod100.z.array(TagCategoryV2Schema).default([]),
...
var BeyondPaperV19Schema = import_zod101.z.object({
  // Format metadata
  version: import_zod101.z.literal(19),
  ...
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod101.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  ...
  variables: import_zod101.z.array(VariableV9Schema).default([]),
  widgets: import_zod101.z.array(WidgetV10Schema).default([]),
  ...
  tags: import_zod101.z.array(TagV3Schema).default([]),
  tagCategories: import_zod101.z.array(TagCategoryV2Schema).default([]),
