...
var WithAudioUrlsV1Schema = import_zod56.z.object({
  audioUrl: import_zod56.z.string().optional(),
  audioDurationSeconds: import_zod56.z.number().optional(),
  audioExt: import_zod56.z.enum(["mp3", "ogg"]).optional()
});

// src/models/asset.v1.schema.ts
var AssetBaseV1Schema = import_zod57.z.object({ uid: AssetUidSchema }).merge(WithNameV1Schema);
var ImageAssetV1Schema = AssetBaseV1Schema.merge(
  WithImagesUrlsV1Schema
).extend({
  type: import_zod57.z.literal("image"),
  dimensions: ImageDimensionsV1Schema
});
var VideoAssetV1Schema = AssetBaseV1Schema.merge(
  WithVideoUrlsV1Schema
).extend({
  type: import_zod57.z.literal("video"),
  dimensions: ImageDimensionsV1Schema
});
var AudioAssetV1Schema = AssetBaseV1Schema.merge(
  WithAudioUrlsV1Schema
).extend({
  type: import_zod57.z.literal("audio")
});
var AudioExternalAssetV1Schema = AssetBaseV1Schema.extend({
  type: import_zod57.z.literal("audio-external"),
  youtubeVideoId: import_zod57.z.string(),
  thumbnailUrl: import_zod57.z.string(),
  durationSeconds: import_zod57.z.number()
});
var EntityAssetV1Schema = AssetBaseV1Schema.extend({
  type: import_zod57.z.literal("entity"),
  entityUid: EntityUidSchema
});
var AssetV1Schema = import_zod57.z.discriminatedUnion("type", [
  ImageAssetV1Schema,
  VideoAssetV1Schema,
  AudioAssetV1Schema,
...
var DatasetTargetV1Schema = import_zod58.z.union([
  EntityTypeV1Schema,
  TagUidSchema
]);
var DatasetV1Schema = import_zod58.z.object({ uid: DatasetUidSchema }).merge(WithNameV1Schema).extend({
  weight: import_zod58.z.number().optional(),
  targets: import_zod58.z.array(DatasetTargetV1Schema),
  targetTagsGroup: import_zod58.z.enum(["every", "some"]).optional(),
  sheetUid: SheetUidSchema.optional()
});

// src/models/dialect.v1.schema.ts
var import_zod59 = require("zod");
var DialectFontV1Schema = import_zod59.z.object({
  fontFamily: import_zod59.z.string(),
  fontUrl: import_zod59.z.string()
});
var DialectV1Schema = import_zod59.z.object({
  uid: DialectUidSchema,
  name: import_zod59.z.string(),
  font: DialectFontV1Schema,
  order: import_zod59.z.number().optional(),
  spokenByEntitiesUids: import_zod59.z.array(EntityUidSchema)
});

// src/models/random-table.v1.schema.ts
var import_zod60 = require("zod");
var RandomTableRowV1Schema = import_zod60.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod60.z.number(),
  content: import_zod60.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV1Schema = import_zod60.z.object({
  uid: RandomTableUidSchema,
  title: import_zod60.z.string(),
  rows: import_zod60.z.array(RandomTableRowV1Schema)
});

// src/models/scene.v1.schema.ts
var import_zod61 = require("zod");
var SceneGameModeV1Schema = import_zod61.z.enum(["2d_vtt", "3d_vtt", "totm"]);
var SceneV1Schema = import_zod61.z.object({ uid: SceneUidSchema }).merge(WithNameV1Schema).extend({
  mapUid: SceneMapUidSchema.nullable().optional(),
  backgroundUid: SceneBackgroundUidSchema.nullable().optional(),
  lightPositionX: import_zod61.z.number().optional(),
  lightPositionY: import_zod61.z.number().optional(),
  lightPositionZ: import_zod61.z.number().optional(),
  lightIntensity: import_zod61.z.number().optional(),
  lightColor: import_zod61.z.string().optional(),
  useCustomLightPosition: import_zod61.z.boolean().optional(),
  indoorLight: import_zod61.z.boolean().optional(),
  weather: import_zod61.z.enum(["none", "fog", "dark"]).nullable().optional(),
  gameMode: SceneGameModeV1Schema.optional()
});

// src/models/scene-background.v1.schema.ts
var import_zod62 = require("zod");
var SceneBackgroundBaseV1Schema = import_zod62.z.object({ uid: SceneBackgroundUidSchema }).merge(WithNameV1Schema).extend({
  opacity: import_zod62.z.number().optional()
});
var CustomImageSceneBackgroundV1Schema = SceneBackgroundBaseV1Schema.merge(WithImagesUrlsV1Schema).extend({
  type: import_zod62.z.literal("customImage")
});
var CustomVideoSceneBackgroundV1Schema = SceneBackgroundBaseV1Schema.merge(WithVideoUrlsV1Schema).extend({
  type: import_zod62.z.literal("customVideo")
});
var SceneBackgroundV1Schema = import_zod62.z.discriminatedUnion("type", [
...
var SheetV2Schema = import_zod63.z.object({ uid: SheetUidSchema }).merge(WithImagesUrlsV1Schema).extend({
  name: import_zod63.z.string().nullable().optional(),
  widgetUids: import_zod63.z.array(WidgetUidSchema),
  compatibleDatasetUid: DatasetUidSchema.optional()
});

// src/models/tag.v1.schema.ts
var import_zod64 = require("zod");
var TagV1Schema = import_zod64.z.object({ uid: TagUidSchema }).merge(WithNameV1Schema).extend({
  categoryUid: TagCategoryUidSchema.nullable(),
  useAsFolder: import_zod64.z.boolean()
});

// src/schemas/bypp.v3.schema.ts
var CcLicenseV3Schema = import_zod65.z.enum([
  "CC0",
  "CC-BY",
  "CC-BY-SA",
  "CC-BY-NC",
...
var AttributionV3Schema = import_zod65.z.object({
  authorName: import_zod65.z.string().min(1),
  authorUrl: import_zod65.z.string().url().optional(),
  sourceUrl: import_zod65.z.string().url().optional()
});
var ParentAttributionV3Schema = import_zod65.z.object({
  artifactName: import_zod65.z.string().min(1),
  authorName: import_zod65.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod65.z.string().url().optional()
});
var BeyondPaperV3Schema = import_zod65.z.object({
  // Format metadata
  version: import_zod65.z.literal(3),
  ...
  // Content
  dialects: import_zod65.z.array(DialectV1Schema),
  entities: import_zod65.z.array(EntityV1Schema),
  pages: import_zod65.z.array(PageV1Schema),
  chunks: import_zod65.z.array(ChunkV1Schema),
  datasets: import_zod65.z.array(DatasetV1Schema),
  variables: import_zod65.z.array(VariableV2Schema),
  widgets: import_zod65.z.array(WidgetV1Schema),
  sheets: import_zod65.z.array(SheetV2Schema),
  dataTables: import_zod65.z.array(DataTableV2Schema),
  randomTables: import_zod65.z.array(RandomTableV1Schema),
  tags: import_zod65.z.array(TagV1Schema),
  tagCategories: import_zod65.z.array(TagCategoryV1Schema),
  scenes: import_zod65.z.array(SceneV1Schema),
  sceneMaps: import_zod65.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod65.z.array(SceneBackgroundV1Schema),
  assets: import_zod65.z.array(AssetV1Schema)
});
...
var EntityBaseV2Schema = import_zod66.z.object({
  uid: EntityUidSchema,
  displayName: import_zod66.z.string().optional(),
  description: import_zod66.z.string().optional(),
  tagsUid: import_zod66.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod66.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var CharacterEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod66.z.literal("character")
});
var CreatureEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod66.z.literal("creature")
});
var GroupEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod66.z.literal("group"),
  ranks: import_zod66.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod66.z.array(EntityUidSchema).default([])
});
var PlaceEntityV2Schema = EntityBaseV2Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod66.z.literal("place") });
var ItemEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod66.z.literal("item")
});
var NoteEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod66.z.literal("note")
});
var AbilityEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod66.z.literal("ability")
});
var StoryEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod66.z.literal("story")
});
var EventEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod66.z.literal("event")
});
var EntityV2Schema = import_zod66.z.discriminatedUnion("type", [
...
var RandomTableRowV2Schema = import_zod67.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod67.z.number().default(1),
  content: import_zod67.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV2Schema = import_zod67.z.object({
  uid: RandomTableUidSchema,
  title: import_zod67.z.string(),
  rows: import_zod67.z.array(RandomTableRowV2Schema).default([])
});

// src/schemas/bypp.v4.schema.ts
var ParentAttributionV4Schema = import_zod68.z.object({
  bundleName: import_zod68.z.string().min(1),
  authorName: import_zod68.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod68.z.string().url().optional()
});
var BeyondPaperV4Schema = import_zod68.z.object({
  // Format metadata
  version: import_zod68.z.literal(4),
  ...
  variables: import_zod68.z.array(VariableV2Schema).default([]),
  widgets: import_zod68.z.array(WidgetV1Schema).default([]),
...
// src/schemas/bypp.v11.schema.ts
var BeyondPaperV11Schema = import_zod69.z.object({
  // Format metadata
  version: import_zod69.z.literal(11),
  ...
  entities: import_zod69.z.array(EntityV3Schema).default([]),
  pages: import_zod69.z.array(PageV1Schema).default([]),
  chunks: import_zod69.z.array(ChunkV11Schema).default([]),
  datasets: import_zod69.z.array(DatasetV2Schema).default([]),
  variables: import_zod69.z.array(VariableV7Schema).default([]),
  widgets: import_zod69.z.array(WidgetV7Schema).default([]),
  sheets: import_zod69.z.array(SheetV6Schema).default([]),
  dataTables: import_zod69.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod69.z.array(RandomTableV7Schema).default([]),
  ...
  sceneMaps: import_zod69.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod69.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod69.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v1.schema.ts
var import_zod70 = require("zod");
var BeyondPaperV1Schema = import_zod70.z.object({
  // Format metadata
  version: import_zod70.z.literal(1),
  ...
  variables: import_zod70.z.array(VariableV1Schema),
...
var BeyondPaperV2Schema = import_zod71.z.object({
  // Format metadata
  version: import_zod71.z.literal(2),
  ...
  variables: import_zod71.z.array(VariableV2Schema),
  widgets: import_zod71.z.array(WidgetV1Schema),
  sheets: import_zod71.z.array(SheetV2Schema),
  dataTables: import_zod71.z.array(DataTableV2Schema),
...
var BeyondPaperV5Schema = import_zod72.z.object({
  // Format metadata
  version: import_zod72.z.literal(5),
  ...
  variables: import_zod72.z.array(VariableV5Schema).default([]),
...
var BeyondPaperV6Schema = import_zod73.z.object({
  // Format metadata
  version: import_zod73.z.literal(6),
...
var BeyondPaperV7Schema = import_zod74.z.object({
  // Format metadata
  version: import_zod74.z.literal(7),
...
var BeyondPaperV8Schema = import_zod75.z.object({
  // Format metadata
  version: import_zod75.z.literal(8),
  ...
  widgets: import_zod75.z.array(WidgetV6Schema).default([]),
  sheets: import_zod75.z.array(SheetV4Schema).default([]),
...
var BeyondPaperV9Schema = import_zod76.z.object({
  // Format metadata
  version: import_zod76.z.literal(9),
  ...
  widgets: import_zod76.z.array(WidgetV7Schema).default([]),
  sheets: import_zod76.z.array(SheetV5Schema).default([]),
...
var BeyondPaperV10Schema = import_zod77.z.object({
  // Format metadata
  version: import_zod77.z.literal(10),
  ...
  entities: import_zod77.z.array(EntityV3Schema).default([]),
  ...
  sheets: import_zod77.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod77.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod77.z.array(SceneBackgroundV3Schema).default([]),
