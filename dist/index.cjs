...
__export(index_exports, {
  ...
  BeyondPaperSchema: () => BeyondPaperV8Schema,
  ...
  WithStyleSchema: () => WithStyleV2Schema,
...
var SheetV3Schema = import_zod35.z.object({ uid: SheetUidSchema }).merge(WithImagesUrlsV2Schema).extend({
  name: import_zod35.z.string().optional(),
  widgetUids: import_zod35.z.array(WidgetUidSchema).default([]),
  compatibleDatasetUid: DatasetUidSchema.optional()
});

// src/models/sheet.v4.schema.ts
var SheetV4Schema = SheetV3Schema.extend({
  styles: import_zod36.z.record(import_zod36.z.string(), StyleV2Schema).optional()
});

// src/models/tag.v2.schema.ts
var import_zod37 = require("zod");
var TagV2Schema = import_zod37.z.object({ uid: TagUidSchema }).merge(WithNameV1Schema).extend({
  categoryUid: TagCategoryUidSchema.optional(),
  useAsFolder: import_zod37.z.boolean().default(false)
});

// src/models/tag-category.v1.schema.ts
var import_zod38 = require("zod");
var TagCategoryV1Schema = import_zod38.z.object({ uid: TagCategoryUidSchema }).merge(WithNameV1Schema);
...
var DataTableRefVariableV2Schema = VariableBaseV1Schema.extend({
  type: import_zod39.z.literal("dataTableRef"),
  dataTableUid: DataTableUidSchema.optional(),
  labelColumnUid: DataTableColumnUidSchema.optional(),
  valueColumnUid: DataTableColumnUidSchema.optional(),
  iconColumnUid: DataTableColumnUidSchema.optional(),
  isMultiple: import_zod39.z.boolean().optional(),
  defaultRowUids: import_zod39.z.array(DataTableRowUidSchema).optional()
});
var DataTableLookupVariableV2Schema = VariableBaseV1Schema.extend({
  type: import_zod39.z.literal("dataTableLookup"),
...
var VariableV2Schema = import_zod39.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var ImageVariableV5Schema = VariableBaseV1Schema.extend({
  type: import_zod40.z.literal("image")
});
var VariableV5Schema = import_zod40.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var DataTableDirectLookupVariableV6Schema = VariableBaseV1Schema.extend(
  {
    type: import_zod41.z.literal("dataTableDirectLookup"),
    dataTableUid: DataTableUidSchema.optional(),
    columnUid: DataTableColumnUidSchema.optional(),
    rowUids: import_zod41.z.array(DataTableRowUidSchema).optional(),
...
var VariableV6Schema = import_zod41.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var WithAreaV1Schema = import_zod42.z.object({
  area: import_zod42.z.object({
...
var WithPositionV1Schema = import_zod43.z.object({
  position: import_zod43.z.object({
    left: import_zod43.z.number(),
    top: import_zod43.z.number()
  }).nullable().optional()
});

// src/mixins/with-style.v1.schema.ts
var import_zod44 = require("zod");
var StyleV1Schema = import_zod44.z.object({
  justifyContent: import_zod44.z.string().optional(),
  alignItems: import_zod44.z.string().optional(),
  flexDirection: import_zod44.z.string().optional(),
  lineHeight: import_zod44.z.number().optional(),
  fontFamilyId: import_zod44.z.string().optional(),
  fontScale: import_zod44.z.number().optional(),
  color: import_zod44.z.string().optional(),
  paddingTop: import_zod44.z.number().optional(),
  paddingRight: import_zod44.z.number().optional(),
  paddingBottom: import_zod44.z.number().optional(),
  paddingLeft: import_zod44.z.number().optional()
}).nullable().optional();
var WithStyleV1Schema = import_zod44.z.object({
  style: StyleV1Schema
});

// src/models/widget.v1.schema.ts
var WidgetBaseV1Schema = import_zod45.z.object({ uid: WidgetUidSchema }).merge(WithNameV1Schema).merge(WithAreaV1Schema).merge(WithPositionV1Schema).merge(WithStyleV1Schema).extend({
  variableUid: VariableUidSchema.optional()
});
var WidgetEmptyV1Schema = WidgetBaseV1Schema.extend({
  type: import_zod45.z.literal("empty")
});
var WidgetBigNumberV1Schema = WidgetBaseV1Schema.extend({
  type: import_zod45.z.literal("bigNumber"),
  min: import_zod45.z.number().optional(),
  max: import_zod45.z.number().optional(),
  maxVariable: VariableUidSchema.nullable().optional(),
  unit: import_zod45.z.string().optional()
});
var WidgetPlainTextV1Schema = WidgetBaseV1Schema.extend({
  type: import_zod45.z.literal("plainText")
});
var WidgetToggleV1Schema = WidgetBaseV1Schema.extend({
  type: import_zod45.z.literal("toggle"),
  toggleIconType: import_zod45.z.string().optional()
});
var WidgetBulletListV1Schema = WidgetBaseV1Schema.extend({
  type: import_zod45.z.literal("bulletList"),
  listVisibility: import_zod45.z.string().optional(),
  listStyleBulletBreakline: import_zod45.z.boolean().optional(),
  listStyleBulletType: import_zod45.z.string().optional(),
  listStyleBulletGap: import_zod45.z.number().optional(),
  listStyleBulletIconGap: import_zod45.z.number().optional(),
  listOptionStyle: import_zod45.z.string().optional()
});
var WidgetInlineListV1Schema = WidgetBaseV1Schema.extend({
  type: import_zod45.z.literal("inlineList"),
  listStyleTextSeparator: import_zod45.z.string().optional(),
  listVisibility: import_zod45.z.string().optional(),
  listOptionStyle: import_zod45.z.string().optional()
});
var WidgetPipsV1Schema = WidgetBaseV1Schema.extend({
  type: import_zod45.z.literal("pips"),
  icon: import_zod45.z.string().optional(),
  gapX: import_zod45.z.number().optional(),
  gapY: import_zod45.z.number().optional(),
  max: import_zod45.z.number().optional(),
  maxVariable: VariableUidSchema.nullable().optional()
});
var BarOrientationV1Schema = import_zod45.z.enum(["ltr", "rtl", "ttb", "btt"]);
var WidgetBarV1Schema = WidgetBaseV1Schema.extend({
  type: import_zod45.z.literal("bar"),
  min: import_zod45.z.number().optional(),
  max: import_zod45.z.number().optional(),
  maxVariable: VariableUidSchema.nullable().optional(),
  unit: import_zod45.z.string().optional(),
  orientation: BarOrientationV1Schema.optional(),
  barColor: import_zod45.z.string().optional(),
  bgColor: import_zod45.z.string().optional(),
  showValue: import_zod45.z.boolean().optional()
});
var WidgetV1Schema = import_zod45.z.discriminatedUnion("type", [
  WidgetEmptyV1Schema,
...
var EntityImageFormatV5Schema = import_zod46.z.enum(ENTITY_IMAGE_RENDITIONS);

// src/models/widget.v5.schema.ts
var EntityImageObjectFitV5Schema = import_zod47.z.enum([
  "contain",
  "cover",
  "fill",
  "none",
...
var WidgetEntityImageV5Schema = WidgetBaseV1Schema.extend({
  type: import_zod47.z.literal("entityImage"),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional()
});
var WidgetV5Schema = import_zod47.z.discriminatedUnion("type", [
  WidgetEmptyV1Schema,
  WidgetBigNumberV1Schema,
  WidgetPlainTextV1Schema,
  WidgetToggleV1Schema,
...
var WidgetV6Schema = import_zod48.z.discriminatedUnion("type", [
  WidgetEmptyV6Schema,
...
var WithAudioUrlsV1Schema = import_zod49.z.object({
  audioUrl: import_zod49.z.string().optional(),
  audioDurationSeconds: import_zod49.z.number().optional(),
  audioExt: import_zod49.z.enum(["mp3", "ogg"]).optional()
});

// src/models/asset.v1.schema.ts
var AssetBaseV1Schema = import_zod50.z.object({ uid: AssetUidSchema }).merge(WithNameV1Schema);
var ImageAssetV1Schema = AssetBaseV1Schema.merge(
  WithImagesUrlsV1Schema
).extend({
  type: import_zod50.z.literal("image"),
  dimensions: ImageDimensionsV1Schema
});
var VideoAssetV1Schema = AssetBaseV1Schema.merge(
  WithVideoUrlsV1Schema
).extend({
  type: import_zod50.z.literal("video"),
  dimensions: ImageDimensionsV1Schema
});
var AudioAssetV1Schema = AssetBaseV1Schema.merge(
  WithAudioUrlsV1Schema
).extend({
  type: import_zod50.z.literal("audio")
});
var AudioExternalAssetV1Schema = AssetBaseV1Schema.extend({
  type: import_zod50.z.literal("audio-external"),
  youtubeVideoId: import_zod50.z.string(),
  thumbnailUrl: import_zod50.z.string(),
  durationSeconds: import_zod50.z.number()
});
var EntityAssetV1Schema = AssetBaseV1Schema.extend({
  type: import_zod50.z.literal("entity"),
  entityUid: EntityUidSchema
});
var AssetV1Schema = import_zod50.z.discriminatedUnion("type", [
  ImageAssetV1Schema,
  VideoAssetV1Schema,
  AudioAssetV1Schema,
...
var DatasetTargetV1Schema = import_zod51.z.union([
  EntityTypeV1Schema,
  TagUidSchema
]);
var DatasetV1Schema = import_zod51.z.object({ uid: DatasetUidSchema }).merge(WithNameV1Schema).extend({
  weight: import_zod51.z.number().optional(),
  targets: import_zod51.z.array(DatasetTargetV1Schema),
  targetTagsGroup: import_zod51.z.enum(["every", "some"]).optional(),
  sheetUid: SheetUidSchema.optional()
});

// src/models/dialect.v1.schema.ts
var import_zod52 = require("zod");
var DialectFontV1Schema = import_zod52.z.object({
  fontFamily: import_zod52.z.string(),
  fontUrl: import_zod52.z.string()
});
var DialectV1Schema = import_zod52.z.object({
  uid: DialectUidSchema,
  name: import_zod52.z.string(),
  font: DialectFontV1Schema,
  order: import_zod52.z.number().optional(),
  spokenByEntitiesUids: import_zod52.z.array(EntityUidSchema)
});

// src/models/random-table.v1.schema.ts
var import_zod53 = require("zod");
var RandomTableRowV1Schema = import_zod53.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod53.z.number(),
  content: import_zod53.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV1Schema = import_zod53.z.object({
  uid: RandomTableUidSchema,
  title: import_zod53.z.string(),
  rows: import_zod53.z.array(RandomTableRowV1Schema)
});

// src/models/scene.v1.schema.ts
var import_zod54 = require("zod");
var SceneGameModeV1Schema = import_zod54.z.enum(["2d_vtt", "3d_vtt", "totm"]);
var SceneV1Schema = import_zod54.z.object({ uid: SceneUidSchema }).merge(WithNameV1Schema).extend({
  ...
  weather: import_zod54.z.enum(["none", "fog", "dark"]).nullable().optional(),
  gameMode: SceneGameModeV1Schema.optional()
});

// src/models/scene-background.v1.schema.ts
var import_zod55 = require("zod");
var SceneBackgroundBaseV1Schema = import_zod55.z.object({ uid: SceneBackgroundUidSchema }).merge(WithNameV1Schema).extend({
...
var SceneBackgroundV1Schema = import_zod55.z.discriminatedUnion("type", [
...
var SheetV2Schema = import_zod56.z.object({ uid: SheetUidSchema }).merge(WithImagesUrlsV1Schema).extend({
  name: import_zod56.z.string().nullable().optional(),
  widgetUids: import_zod56.z.array(WidgetUidSchema),
  compatibleDatasetUid: DatasetUidSchema.optional()
});

// src/models/tag.v1.schema.ts
var import_zod57 = require("zod");
var TagV1Schema = import_zod57.z.object({ uid: TagUidSchema }).merge(WithNameV1Schema).extend({
  categoryUid: TagCategoryUidSchema.nullable(),
  useAsFolder: import_zod57.z.boolean()
});

// src/schemas/bypp.v3.schema.ts
var CcLicenseV3Schema = import_zod58.z.enum([
  "CC0",
  "CC-BY",
  "CC-BY-SA",
  "CC-BY-NC",
...
var AttributionV3Schema = import_zod58.z.object({
  authorName: import_zod58.z.string().min(1),
  authorUrl: import_zod58.z.string().url().optional(),
  sourceUrl: import_zod58.z.string().url().optional()
});
var ParentAttributionV3Schema = import_zod58.z.object({
  artifactName: import_zod58.z.string().min(1),
  authorName: import_zod58.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod58.z.string().url().optional()
});
var BeyondPaperV3Schema = import_zod58.z.object({
  // Format metadata
  version: import_zod58.z.literal(3),
  ...
  // Content
  dialects: import_zod58.z.array(DialectV1Schema),
  entities: import_zod58.z.array(EntityV1Schema),
  pages: import_zod58.z.array(PageV1Schema),
  chunks: import_zod58.z.array(ChunkV1Schema),
  datasets: import_zod58.z.array(DatasetV1Schema),
  variables: import_zod58.z.array(VariableV2Schema),
  widgets: import_zod58.z.array(WidgetV1Schema),
  sheets: import_zod58.z.array(SheetV2Schema),
  dataTables: import_zod58.z.array(DataTableV2Schema),
  randomTables: import_zod58.z.array(RandomTableV1Schema),
  tags: import_zod58.z.array(TagV1Schema),
  tagCategories: import_zod58.z.array(TagCategoryV1Schema),
  scenes: import_zod58.z.array(SceneV1Schema),
  sceneMaps: import_zod58.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod58.z.array(SceneBackgroundV1Schema),
  assets: import_zod58.z.array(AssetV1Schema)
});
...
var RandomTableRowV2Schema = import_zod59.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod59.z.number().default(1),
  content: import_zod59.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV2Schema = import_zod59.z.object({
  uid: RandomTableUidSchema,
  title: import_zod59.z.string(),
  rows: import_zod59.z.array(RandomTableRowV2Schema).default([])
});

// src/schemas/bypp.v4.schema.ts
var ParentAttributionV4Schema = import_zod60.z.object({
  bundleName: import_zod60.z.string().min(1),
  authorName: import_zod60.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod60.z.string().url().optional()
});
var BeyondPaperV4Schema = import_zod60.z.object({
  // Format metadata
  version: import_zod60.z.literal(4),
  ...
  license: CcLicenseV3Schema,
  licenseVersion: import_zod60.z.literal("4.0"),
  attribution: AttributionV3Schema,
  parentAttribution: ParentAttributionV4Schema.optional(),
  creatorLinks: import_zod60.z.array(import_zod60.z.string().url()).optional(),
  ...
  dialects: import_zod60.z.array(DialectV2Schema).default([]),
  entities: import_zod60.z.array(EntityV2Schema).default([]),
  pages: import_zod60.z.array(PageV1Schema).default([]),
  chunks: import_zod60.z.array(ChunkV2Schema).default([]),
  datasets: import_zod60.z.array(DatasetV2Schema).default([]),
  variables: import_zod60.z.array(VariableV2Schema).default([]),
  widgets: import_zod60.z.array(WidgetV1Schema).default([]),
  sheets: import_zod60.z.array(SheetV3Schema).default([]),
  dataTables: import_zod60.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod60.z.array(RandomTableV2Schema).default([]),
  tags: import_zod60.z.array(TagV2Schema).default([]),
  tagCategories: import_zod60.z.array(TagCategoryV1Schema).default([]),
  scenes: import_zod60.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod60.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod60.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod60.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v8.schema.ts
var BeyondPaperV8Schema = import_zod61.z.object({
  // Format metadata
  version: import_zod61.z.literal(8),
  ...
  variables: import_zod61.z.array(VariableV6Schema).default([]),
  widgets: import_zod61.z.array(WidgetV6Schema).default([]),
  sheets: import_zod61.z.array(SheetV4Schema).default([]),
  dataTables: import_zod61.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod61.z.array(RandomTableV7Schema).default([]),
...
var BeyondPaperV1Schema = import_zod62.z.object({
  // Format metadata
  ...
  variables: import_zod62.z.array(VariableV1Schema),
...
var BeyondPaperV2Schema = import_zod63.z.object({
  // Format metadata
  version: import_zod63.z.literal(2),
  format: import_zod63.z.literal("bypp"),
  // Bundle metadata
  name: import_zod63.z.string(),
  exportedAt: import_zod63.z.string(),
  bundleVersion: import_zod63.z.string(),
  // Content
  dialects: import_zod63.z.array(DialectV1Schema),
  entities: import_zod63.z.array(EntityV1Schema),
  pages: import_zod63.z.array(PageV1Schema),
  chunks: import_zod63.z.array(ChunkV1Schema),
  datasets: import_zod63.z.array(DatasetV1Schema),
  variables: import_zod63.z.array(VariableV2Schema),
  widgets: import_zod63.z.array(WidgetV1Schema),
  sheets: import_zod63.z.array(SheetV2Schema),
  dataTables: import_zod63.z.array(DataTableV2Schema),
  randomTables: import_zod63.z.array(RandomTableV1Schema),
  tags: import_zod63.z.array(TagV1Schema),
  tagCategories: import_zod63.z.array(TagCategoryV1Schema),
  scenes: import_zod63.z.array(SceneV1Schema),
  sceneMaps: import_zod63.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod63.z.array(SceneBackgroundV1Schema),
  assets: import_zod63.z.array(AssetV1Schema)
});

// src/schemas/bypp.v5.schema.ts
var import_zod64 = require("zod");
var BeyondPaperV5Schema = import_zod64.z.object({
  // Format metadata
  version: import_zod64.z.literal(5),
  ...
  variables: import_zod64.z.array(VariableV5Schema).default([]),
  widgets: import_zod64.z.array(WidgetV5Schema).default([]),
...
var BeyondPaperV6Schema = import_zod65.z.object({
  // Format metadata
  version: import_zod65.z.literal(6),
  ...
  variables: import_zod65.z.array(VariableV6Schema).default([]),
  widgets: import_zod65.z.array(WidgetV5Schema).default([]),
  sheets: import_zod65.z.array(SheetV3Schema).default([]),
  dataTables: import_zod65.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod65.z.array(RandomTableV2Schema).default([]),
...
var BeyondPaperV7Schema = import_zod66.z.object({
  // Format metadata
  version: import_zod66.z.literal(7),
  ...
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod66.z.array(DialectV2Schema).default([]),
  entities: import_zod66.z.array(EntityV2Schema).default([]),
  pages: import_zod66.z.array(PageV1Schema).default([]),
  chunks: import_zod66.z.array(ChunkV2Schema).default([]),
  datasets: import_zod66.z.array(DatasetV2Schema).default([]),
  variables: import_zod66.z.array(VariableV6Schema).default([]),
  widgets: import_zod66.z.array(WidgetV5Schema).default([]),
  sheets: import_zod66.z.array(SheetV3Schema).default([]),
  dataTables: import_zod66.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod66.z.array(RandomTableV7Schema).default([]),
  tags: import_zod66.z.array(TagV2Schema).default([]),
  tagCategories: import_zod66.z.array(TagCategoryV1Schema).default([]),
  scenes: import_zod66.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod66.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod66.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod66.z.array(AssetV2Schema).default([])
});
