...
__export(index_exports, {
  AbilityEntitySchema: () => AbilityEntityV4Schema,
  ...
  CharacterEntitySchema: () => CharacterEntityV4Schema,
  ...
  CreatureEntitySchema: () => CreatureEntityV4Schema,
  ...
  EntityBaseSchema: () => EntityBaseV4Schema,
  ...
  EventEntitySchema: () => EventEntityV4Schema,
  ...
  GroupEntitySchema: () => GroupEntityV4Schema,
  ...
  ItemEntitySchema: () => ItemEntityV4Schema,
  ...
  NoteEntitySchema: () => NoteEntityV4Schema,
  ...
  PlaceEntitySchema: () => PlaceEntityV4Schema,
  ...
  StoryEntitySchema: () => StoryEntityV4Schema,
...
var ByppFileUrlV1Schema = import_zod51.z.string().url().refine(
  (url) => {
    try {
...
var RequirementSourceV1Schema = import_zod51.z.object({
  byppUrl: ByppFileUrlV1Schema,
  bundleName: import_zod51.z.string().optional(),
  bundleVersion: import_zod51.z.string().optional()
});
var RequirementV1Schema = import_zod51.z.object({
  category: import_zod51.z.string(),
  uid: import_zod51.z.string(),
  name: import_zod51.z.string().optional(),
  from: RequirementSourceV1Schema.optional()
});

// src/models/scene.v2.schema.ts
var import_zod52 = require("zod");
var SceneV2Schema = import_zod52.z.object({ uid: SceneUidSchema }).merge(WithNameV1Schema).extend({
  mapUid: SceneMapUidSchema.optional(),
  backgroundUid: SceneBackgroundUidSchema.optional(),
  lightPositionX: import_zod52.z.number().optional(),
  lightPositionY: import_zod52.z.number().optional(),
  lightPositionZ: import_zod52.z.number().optional(),
  lightIntensity: import_zod52.z.number().optional(),
  lightColor: import_zod52.z.string().optional(),
  useCustomLightPosition: import_zod52.z.boolean().optional(),
  indoorLight: import_zod52.z.boolean().optional()
});
...
var SceneBackgroundBaseV2Schema = import_zod53.z.object({ uid: SceneBackgroundUidSchema }).merge(WithNameV1Schema).extend({
  opacity: import_zod53.z.number().optional()
});
...
var SceneBackgroundV2Schema = import_zod53.z.discriminatedUnion("type", [
...
var CustomImageSceneBackgroundV3Schema = SceneBackgroundBaseV2Schema.merge(WithImagesUrlsV3Schema).extend({
  type: import_zod54.z.literal("customImage")
});
var CustomVideoSceneBackgroundV3Schema = SceneBackgroundBaseV2Schema.merge(WithVideoUrlsV2Schema).extend({
  type: import_zod54.z.literal("customVideo")
});
var SceneBackgroundV3Schema = import_zod54.z.discriminatedUnion("type", [
...
var SceneBackgroundV4Schema = import_zod55.z.discriminatedUnion("type", [
...
var SceneMapBaseV2Schema = import_zod56.z.object({ uid: SceneMapUidSchema }).merge(WithNameV1Schema).extend({
  grid: GridDataV1Schema,
  sourceFormat: import_zod56.z.string().optional()
});
...
var SceneMapV2Schema = import_zod56.z.discriminatedUnion("type", [
...
var SceneMapV3Schema = import_zod57.z.discriminatedUnion("type", [
...
var SceneMapV4Schema = import_zod58.z.discriminatedUnion("type", [
...
var ObjectFitV6Schema = import_zod59.z.enum([
  "cover",
  "contain",
  "fill",
  "none",
...
var WidgetBackgroundV6Schema = import_zod59.z.object({
  assetUid: AssetUidSchema,
  objectFit: ObjectFitV6Schema.optional()
});
var StyleV2Schema = import_zod59.z.object({
  justifyContent: import_zod59.z.string().optional(),
  alignItems: import_zod59.z.string().optional(),
  flexDirection: import_zod59.z.string().optional(),
  lineHeight: import_zod59.z.number().optional(),
  fontFamilyId: import_zod59.z.string().optional(),
  fontScale: import_zod59.z.number().optional(),
  color: import_zod59.z.string().optional(),
  paddingTop: import_zod59.z.number().optional(),
  paddingRight: import_zod59.z.number().optional(),
  paddingBottom: import_zod59.z.number().optional(),
  paddingLeft: import_zod59.z.number().optional(),
  // New in v2:
  borderWidth: import_zod59.z.number().optional(),
  borderStyle: import_zod59.z.string().optional(),
  borderColor: import_zod59.z.string().optional(),
  borderRadius: import_zod59.z.string().optional(),
  background: WidgetBackgroundV6Schema.optional()
}).nullable().optional();
var WithStyleV2Schema = import_zod59.z.object({
  style: StyleV2Schema
});

// src/mixins/with-style.v3.schema.ts
var StyleV3Schema = StyleV2Schema.unwrap().unwrap().extend({
  rotation: import_zod60.z.number().optional()
}).nullable().optional();
var WithStyleV3Schema = import_zod60.z.object({
  style: StyleV3Schema
});
...
var SheetV3Schema = import_zod61.z.object({ uid: SheetUidSchema }).merge(WithImagesUrlsV2Schema).extend({
  name: import_zod61.z.string().optional(),
  widgetUids: import_zod61.z.array(WidgetUidSchema).default([]),
  compatibleDatasetUid: DatasetUidSchema.optional()
});

// src/models/sheet.v4.schema.ts
var SheetV4Schema = SheetV3Schema.extend({
  styles: import_zod62.z.record(import_zod62.z.string(), StyleV2Schema).optional()
});

// src/models/sheet.v5.schema.ts
var SheetV5Schema = SheetV4Schema.extend({
  styles: import_zod63.z.record(import_zod63.z.string(), StyleV3Schema).optional()
});
...
var TagV2Schema = import_zod65.z.object({ uid: TagUidSchema }).merge(WithNameV1Schema).extend({
  categoryUid: TagCategoryUidSchema.optional(),
  useAsFolder: import_zod65.z.boolean().default(false)
});
...
var ImageVariableV5Schema = VariableBaseV1Schema.extend({
  type: import_zod66.z.literal("image")
});
var VariableV5Schema = import_zod66.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var DataTableDirectLookupVariableV6Schema = VariableBaseV1Schema.extend(
  {
    type: import_zod67.z.literal("dataTableDirectLookup"),
    dataTableUid: DataTableUidSchema.optional(),
    columnUid: DataTableColumnUidSchema.optional(),
    rowUids: import_zod67.z.array(DataTableRowUidSchema).optional(),
    chainedLabelColumnUids: import_zod67.z.array(DataTableColumnUidSchema).optional(),
    multiAggregator: import_zod67.z.enum(["concat", "sum", "avg", "min", "max"]).optional(),
    multiSeparator: import_zod67.z.string().optional()
  }
);
var VariableV6Schema = import_zod67.z.discriminatedUnion("type", [
  NumberVariableV1Schema,
  TextVariableV1Schema,
  BooleanVariableV1Schema,
  ChoiceVariableV1Schema,
...
var NumberVariableV2Schema = NumberVariableV1Schema.extend({
  min: import_zod68.z.number().optional(),
  max: import_zod68.z.number().optional(),
  step: import_zod68.z.number().optional()
});
var VariableV7Schema = import_zod68.z.discriminatedUnion("type", [
...
var VariableV8Schema = import_zod69.z.discriminatedUnion("type", [
...
var EntityRefVariableV9Schema = VariableBaseV8Schema.extend({
  type: import_zod70.z.literal("entityRef"),
  sourceVariableUid: VariableUidSchema.optional(),
  targetsTypes: import_zod70.z.array(import_zod70.z.string()).optional(),
  targetsTags: import_zod70.z.array(TagUidSchema).optional(),
  targetTagsGroup: import_zod70.z.enum(["every", "some"]).optional(),
  max: import_zod70.z.number().optional(),
  maxVariable: VariableUidSchema.nullable().optional()
});
var EntityLookupVariableV9Schema = VariableBaseV8Schema.extend({
  type: import_zod70.z.literal("entityLookup"),
  sourceVariableUid: VariableUidSchema.optional(),
...
var VariableV9Schema = import_zod70.z.discriminatedUnion("type", [
  NumberVariableV8Schema,
  TextVariableV8Schema,
  BooleanVariableV8Schema,
  ChoiceVariableV8Schema,
...
var EntityImageFormatV5Schema = import_zod71.z.enum(ENTITY_IMAGE_RENDITIONS);

// src/models/widget.v5.schema.ts
var import_zod72 = require("zod");
var EntityImageObjectFitV5Schema = import_zod72.z.enum([
  "contain",
  "cover",
  "fill",
  "none",
...
var WidgetEntityImageV5Schema = WidgetBaseV1Schema.extend({
  type: import_zod72.z.literal("entityImage"),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional()
});
var WidgetV5Schema = import_zod72.z.discriminatedUnion("type", [
  WidgetEmptyV1Schema,
  WidgetBigNumberV1Schema,
  WidgetPlainTextV1Schema,
  WidgetToggleV1Schema,
...
var WidgetV6Schema = import_zod73.z.discriminatedUnion("type", [
  WidgetEmptyV6Schema,
...
var WidgetWheelV7Schema = WidgetBaseV1Schema.merge(
  ...
  type: import_zod74.z.literal("wheel"),
  readingPosition: import_zod74.z.string().optional(),
  labelOrientation: import_zod74.z.string().optional(),
  radius: import_zod74.z.number().optional()
});
var WidgetV7Schema = import_zod74.z.discriminatedUnion("type", [
...
// src/models/widget.v8.schema.ts
var WithWidgetActionsV8Schema = import_zod75.z.object({
  actionsVariablesUids: import_zod75.z.array(VariableUidSchema).optional()
});
var WidgetActionRollV8Schema = WidgetBaseV1Schema.merge(
  WithStyleV3Schema
).merge(WithWidgetActionsV8Schema).extend({
  type: import_zod75.z.literal("actionRoll")
});
var WidgetV8Schema = import_zod75.z.discriminatedUnion("type", [
...
var WidgetV9Schema = import_zod76.z.discriminatedUnion("type", [
...
var WidgetEntityGridV10Schema = WidgetBaseV1Schema.extend({
  type: import_zod77.z.literal("entityGrid"),
  gapX: import_zod77.z.number().optional(),
  gapY: import_zod77.z.number().optional(),
  listOptionStyle: import_zod77.z.string().optional(),
  formatSlug: EntityImageFormatV5Schema.optional(),
  objectFit: EntityImageObjectFitV5Schema.optional(),
  imageWidth: import_zod77.z.number().optional(),
  imageHeight: import_zod77.z.number().optional()
}).merge(WithStyleV3Schema).merge(WithWidgetActionsV8Schema).merge(WithCreditV1Schema);
var WidgetV10Schema = import_zod77.z.discriminatedUnion("type", [
...
var DialectFontV2Schema = import_zod78.z.object({
  fontFamily: import_zod78.z.string(),
  fontUrl: import_zod78.z.string().url()
});
var DialectV2Schema = import_zod78.z.object({
  uid: DialectUidSchema,
  name: import_zod78.z.string(),
  font: DialectFontV2Schema,
  order: import_zod78.z.number().optional(),
  spokenByEntitiesUids: import_zod78.z.array(EntityUidSchema).default([])
});

// src/models/entity.v2.schema.ts
var import_zod79 = require("zod");
var EntityBaseV2Schema = import_zod79.z.object({
  uid: EntityUidSchema,
  displayName: import_zod79.z.string().optional(),
  description: import_zod79.z.string().optional(),
  tagsUid: import_zod79.z.array(TagUidSchema).default([]),
  sheetOverrides: import_zod79.z.record(DatasetUidSchema, SheetUidSchema).optional()
...
var CharacterEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod79.z.literal("character")
});
var CreatureEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod79.z.literal("creature")
});
var GroupEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod79.z.literal("group"),
  ranks: import_zod79.z.array(GroupRankV1Schema).default([]),
  charactersUids: import_zod79.z.array(EntityUidSchema).default([])
});
var PlaceEntityV2Schema = EntityBaseV2Schema.merge(
  WithScenesV2Schema
).extend({ type: import_zod79.z.literal("place") });
var ItemEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod79.z.literal("item")
});
var NoteEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod79.z.literal("note")
});
var AbilityEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod79.z.literal("ability")
});
var StoryEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod79.z.literal("story")
});
var EventEntityV2Schema = EntityBaseV2Schema.extend({
  type: import_zod79.z.literal("event")
});
var EntityV2Schema = import_zod79.z.discriminatedUnion("type", [
...
var RandomTableRowV2Schema = import_zod80.z.object({
  uid: RandomTableRowUidSchema,
  range: import_zod80.z.number().default(1),
  content: import_zod80.z.string(),
  randomTableUid: RandomTableUidSchema.optional()
});
var RandomTableV2Schema = import_zod80.z.object({
  uid: RandomTableUidSchema,
  title: import_zod80.z.string(),
  rows: import_zod80.z.array(RandomTableRowV2Schema).default([])
});

// src/schemas/bypp.v4.schema.ts
var ParentAttributionV4Schema = import_zod81.z.object({
  bundleName: import_zod81.z.string().min(1),
  authorName: import_zod81.z.string().min(1),
  license: CcLicenseV3Schema,
  sourceUrl: import_zod81.z.string().url().optional()
});
var BeyondPaperV4Schema = import_zod81.z.object({
  // Format metadata
  version: import_zod81.z.literal(4),
  ...
  variables: import_zod81.z.array(VariableV2Schema).default([]),
  widgets: import_zod81.z.array(WidgetV1Schema).default([]),
  sheets: import_zod81.z.array(SheetV3Schema).default([]),
  dataTables: import_zod81.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod81.z.array(RandomTableV2Schema).default([]),
...
// src/schemas/bypp.v19.schema.ts
var BeyondPaperV19Schema = import_zod82.z.object({
  // Format metadata
  version: import_zod82.z.literal(19),
  ...
  requires: import_zod82.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  dialects: import_zod82.z.array(DialectV3Schema).default([]),
  entities: import_zod82.z.array(EntityV4Schema).default([]),
  pages: import_zod82.z.array(PageV1Schema).default([]),
  chunks: import_zod82.z.array(ChunkV11Schema).default([]),
  datasets: import_zod82.z.array(DatasetV2Schema).default([]),
  variables: import_zod82.z.array(VariableV9Schema).default([]),
  widgets: import_zod82.z.array(WidgetV10Schema).default([]),
  sheets: import_zod82.z.array(SheetV7Schema).default([]),
  dataTables: import_zod82.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod82.z.array(RandomTableV7Schema).default([]),
  tags: import_zod82.z.array(TagV3Schema).default([]),
  tagCategories: import_zod82.z.array(TagCategoryV2Schema).default([]),
  scenes: import_zod82.z.array(SceneV2Schema).default([]),
  sceneMaps: import_zod82.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod82.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod82.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v1.schema.ts
var import_zod83 = require("zod");
var BeyondPaperV1Schema = import_zod83.z.object({
  // Format metadata
  version: import_zod83.z.literal(1),
  ...
  // Content
  dialects: import_zod83.z.array(DialectV1Schema),
  entities: import_zod83.z.array(EntityV1Schema),
  pages: import_zod83.z.array(PageV1Schema),
  chunks: import_zod83.z.array(ChunkV1Schema),
  datasets: import_zod83.z.array(DatasetV1Schema),
  variables: import_zod83.z.array(VariableV1Schema),
  widgets: import_zod83.z.array(WidgetV1Schema),
  randomTables: import_zod83.z.array(RandomTableV1Schema),
  tags: import_zod83.z.array(TagV1Schema),
  tagCategories: import_zod83.z.array(TagCategoryV1Schema),
  scenes: import_zod83.z.array(SceneV1Schema),
  sceneMaps: import_zod83.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod83.z.array(SceneBackgroundV1Schema),
  assets: import_zod83.z.array(AssetV1Schema)
});

// src/schemas/bypp.v2.schema.ts
var import_zod84 = require("zod");
var BeyondPaperV2Schema = import_zod84.z.object({
  // Format metadata
  version: import_zod84.z.literal(2),
  ...
  // Content
  dialects: import_zod84.z.array(DialectV1Schema),
  entities: import_zod84.z.array(EntityV1Schema),
  pages: import_zod84.z.array(PageV1Schema),
  chunks: import_zod84.z.array(ChunkV1Schema),
  datasets: import_zod84.z.array(DatasetV1Schema),
  variables: import_zod84.z.array(VariableV2Schema),
  widgets: import_zod84.z.array(WidgetV1Schema),
  sheets: import_zod84.z.array(SheetV2Schema),
  dataTables: import_zod84.z.array(DataTableV2Schema),
  randomTables: import_zod84.z.array(RandomTableV1Schema),
  tags: import_zod84.z.array(TagV1Schema),
  tagCategories: import_zod84.z.array(TagCategoryV1Schema),
  scenes: import_zod84.z.array(SceneV1Schema),
  sceneMaps: import_zod84.z.array(SceneMapV1Schema),
  sceneBackgrounds: import_zod84.z.array(SceneBackgroundV1Schema),
  assets: import_zod84.z.array(AssetV1Schema)
});

// src/schemas/bypp.v5.schema.ts
var import_zod85 = require("zod");
var BeyondPaperV5Schema = import_zod85.z.object({
  // Format metadata
  version: import_zod85.z.literal(5),
  ...
  entities: import_zod85.z.array(EntityV2Schema).default([]),
  pages: import_zod85.z.array(PageV1Schema).default([]),
  chunks: import_zod85.z.array(ChunkV2Schema).default([]),
  datasets: import_zod85.z.array(DatasetV2Schema).default([]),
  variables: import_zod85.z.array(VariableV5Schema).default([]),
  widgets: import_zod85.z.array(WidgetV5Schema).default([]),
  sheets: import_zod85.z.array(SheetV3Schema).default([]),
  dataTables: import_zod85.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod85.z.array(RandomTableV2Schema).default([]),
  ...
  sceneMaps: import_zod85.z.array(SceneMapV2Schema).default([]),
  sceneBackgrounds: import_zod85.z.array(SceneBackgroundV2Schema).default([]),
  assets: import_zod85.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v6.schema.ts
var import_zod86 = require("zod");
var BeyondPaperV6Schema = import_zod86.z.object({
  // Format metadata
  version: import_zod86.z.literal(6),
  ...
  variables: import_zod86.z.array(VariableV6Schema).default([]),
  widgets: import_zod86.z.array(WidgetV5Schema).default([]),
...
var BeyondPaperV7Schema = import_zod87.z.object({
  // Format metadata
  version: import_zod87.z.literal(7),
  ...
  variables: import_zod87.z.array(VariableV6Schema).default([]),
...
var BeyondPaperV8Schema = import_zod88.z.object({
  // Format metadata
  version: import_zod88.z.literal(8),
  ...
  widgets: import_zod88.z.array(WidgetV6Schema).default([]),
  sheets: import_zod88.z.array(SheetV4Schema).default([]),
  dataTables: import_zod88.z.array(DataTableV3Schema).default([]),
  randomTables: import_zod88.z.array(RandomTableV7Schema).default([]),
...
var BeyondPaperV9Schema = import_zod89.z.object({
  // Format metadata
  version: import_zod89.z.literal(9),
  ...
  variables: import_zod89.z.array(VariableV7Schema).default([]),
  widgets: import_zod89.z.array(WidgetV7Schema).default([]),
  sheets: import_zod89.z.array(SheetV5Schema).default([]),
...
var BeyondPaperV10Schema = import_zod90.z.object({
  // Format metadata
  version: import_zod90.z.literal(10),
  ...
  entities: import_zod90.z.array(EntityV3Schema).default([]),
  ...
  variables: import_zod90.z.array(VariableV7Schema).default([]),
  widgets: import_zod90.z.array(WidgetV7Schema).default([]),
  sheets: import_zod90.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod90.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod90.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod90.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v11.schema.ts
var import_zod91 = require("zod");
var BeyondPaperV11Schema = import_zod91.z.object({
  // Format metadata
  version: import_zod91.z.literal(11),
  ...
  entities: import_zod91.z.array(EntityV3Schema).default([]),
  pages: import_zod91.z.array(PageV1Schema).default([]),
  chunks: import_zod91.z.array(ChunkV11Schema).default([]),
  ...
  sheets: import_zod91.z.array(SheetV6Schema).default([]),
  ...
  sceneMaps: import_zod91.z.array(SceneMapV3Schema).default([]),
  sceneBackgrounds: import_zod91.z.array(SceneBackgroundV3Schema).default([]),
  assets: import_zod91.z.array(AssetV2Schema).default([])
});

// src/schemas/bypp.v12.schema.ts
var import_zod92 = require("zod");
var BeyondPaperV12Schema = import_zod92.z.object({
  // Format metadata
  version: import_zod92.z.literal(12),
...
var BeyondPaperV13Schema = import_zod93.z.object({
  // Format metadata
  version: import_zod93.z.literal(13),
...
var BeyondPaperV14Schema = import_zod94.z.object({
  // Format metadata
  version: import_zod94.z.literal(14),
  ...
  entities: import_zod94.z.array(EntityV4Schema).default([]),
  ...
  widgets: import_zod94.z.array(WidgetV9Schema).default([]),
  sheets: import_zod94.z.array(SheetV7Schema).default([]),
  ...
  sceneMaps: import_zod94.z.array(SceneMapV4Schema).default([]),
  sceneBackgrounds: import_zod94.z.array(SceneBackgroundV4Schema).default([]),
  assets: import_zod94.z.array(AssetV3Schema).default([])
});

// src/schemas/bypp.v15.schema.ts
var import_zod95 = require("zod");
var BeyondPaperV15Schema = import_zod95.z.object({
  // Format metadata
  version: import_zod95.z.literal(15),
...
var BeyondPaperV16Schema = import_zod96.z.object({
  // Format metadata
  version: import_zod96.z.literal(16),
  ...
  variables: import_zod96.z.array(VariableV8Schema).default([]),
...
var BeyondPaperV17Schema = import_zod97.z.object({
  // Format metadata
  version: import_zod97.z.literal(17),
  ...
  variables: import_zod97.z.array(VariableV8Schema).default([]),
  ...
  tags: import_zod97.z.array(TagV3Schema).default([]),
  tagCategories: import_zod97.z.array(TagCategoryV2Schema).default([]),
...
var BeyondPaperV18Schema = import_zod98.z.object({
  // Format metadata
  version: import_zod98.z.literal(18),
  ...
  // What the document reads but does not carry — items another bundle, linked
  // alongside, is expected to provide. Empty for a self-contained document.
  requires: import_zod98.z.array(RequirementV1Schema).default([]),
  // Content — every category defaults to `[]`. Producers may omit any
  // unused category to cut file size; readers always see a concrete array.
  ...
  tags: import_zod98.z.array(TagV3Schema).default([]),
  tagCategories: import_zod98.z.array(TagCategoryV2Schema).default([]),
